...
namespace xs {
    ...
    enum class IdBit : unsigned long long {
        ...
        ATTR_ONLY = 1LL << 60,      ///< Only attribute, forbidden in style
        SPECIAL = 1LL << 61,        ///< Special cases
        FREE_STRING = 1LL << 62,    ///< The type is free unparsed string
        ...
        COMBO_ID_VERSION = FORMAL_STRING | ATTR_ONLY | NOT_INHERITED
    };
