...
Избегайте самопересекающихся ЗАЛИТЫХ объектов — лучше делать их разными объектами. Ну разве что внутренний угол можно делать самопересекающимся для удобства. Линии, имеющие ширину, самопересекаться могут. Неодносвязные объекты (объекты из нескольких контуров, или объект с дырой, или два объекта, combine’d в один) разрешены.
