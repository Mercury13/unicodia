...
Жёлтый — должно стать пустотой, при экспорте вычесть. Пример: человек тащит кувшин на плече. Те части плеча, которые будут закрыты кувшином, прикурываем жёлтым объектом, это максимально человекоредактируемо.
