...
Избегайте самопересекающихся ЗАЛИТЫХ объектов — лучше делать их разными объектами. Ну разве что внутренний угол можно делать самопересекающимся для удобства. Линии, имеющие ширину, самопересекаться могут. Неодносвязные объекты (то есть объект с дырой, или два объекта, combine’d в один) разрешены.
