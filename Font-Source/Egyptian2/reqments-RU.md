...
Файл нужен самый человекоредактируемый, в формате Inkscape SVG. «Самый человекоредактируемый» означает: не надо без нужды объединять контуры в один, не надо без нужды превращать редактируемые линии в залитые объекты. Если экспортируете в SVG из другого софта — просто смотрите, как оно будет экспортировано, и старайтесь не пользоваться эффектами. Встроенные эффекты Inkscape разрешены.
...
ЛИНИЯ С ТОЛЩИНОЙ самопересекаться может, в любом случае она будет преобразована в залитый при экспорте.
