...
struct RecolorLib {
    ...
    std::string_view merBrowsNeu; ///< used in new U18 merperson
    std::string_view merBrowsLady; ///< used in new U18 mermaid
    std::string_view merBrowsMan; ///< used in new U18 merman
