...
constexpr QColor DT_CJK { 0xAD, 0x7F, 0xA8 };     // Dark FG: Tango light violet
...
constexpr QColor DK_AFRICA { 0x5E, 0x3A, 0x01 };  // Dark BG: same but * 2/3
constexpr QColor DT_AFRICA { 0xAD, 0x89, 0x53 };  // Dark FG: Tango light brown * 3/4
