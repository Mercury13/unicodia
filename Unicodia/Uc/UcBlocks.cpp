...
constinit const uc::Block uc::blocks[] {
    ...
    { 0xFB00, 0xFB4F, { L'ﬃ', EcContinent::NONE, Ifg::PAINT_SVG, 13_hy + ImbaY::ABOVE_4 },
    ...
    /// @todo [U17, small tofu] Misc sym supp
    { 0x1CEC0, 0x1CEFF, { 0x1CEEA, EcContinent::NONE, Ifg::PAINT_SVG },
