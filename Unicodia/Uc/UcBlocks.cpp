...
constinit const uc::Block uc::blocks[] {
    ...
    { 0x0300, 0x036F, { 0x301, EcContinent::NONE },
            ...
            { EcScript::ZDIA, 0 }, MapType::SYM_PUNCT,
    ...
    { 0x0780, 0x07BF, { 0x798, EcContinent::OCEAN },
            "Thaana",
            { EcScript::Thaa, 0 }, MapType::OC, EcScript::Thaa },
    // N’ko OK
    ...
    { 0x0D00, 0x0D7F, { 0xD16, EcContinent::ASIA, {}, SvgHint{ 15, 13 } },
            "Malayalam",
            { EcScript::Mlym, 0 }, MapType::AS_BRAH, EcScript::Mlym },
    // Sinhala OK
    { 0x0D80, 0x0DFF, { 0xD9A, EcContinent::OCEAN },
            "Sinhala",
            { EcScript::Sinh, 0 }, MapType::OC, EcScript::Sinh },
    // Thai OK
    { 0x0E00, 0x0E7F, { 0xE0A, EcContinent::ASIA },
            "Thai",
            { EcScript::Thai, 0 }, MapType::AS_BRAH, EcScript::Thai },
    // Lao OK
    { 0x0E80, 0x0EFF, { 0xE9D, EcContinent::ASIA },
            "Lao",
            { EcScript::Laoo, 0 }, MapType::AS_BRAH, EcScript::Laoo },
    // Tibetan OK
    ...
    { 0x1000, 0x109F, { 0x101E, EcContinent::ASIA },
            "Myanmar",
            { EcScript::Mymr, 0 }, MapType::AS_BRAH, EcScript::Mymr },
    // Georgian OK
    { 0x10A0, 0x10FF, { 0x10D3, EcContinent::EUROPE },
            "Georgian",
            { EcScript::Geor, 0 }, MapType::AS_BRAH, EcScript::Geor },
    { 0x1100, 0x11FF, { 0x113F, EcContinent::CJK },
            "Hangul Jamo",
            { EcScript::Hang, 0 }, MapType::CJ_OTHER,
    ...
    { 0x1AB0, 0x1AFF, { 0x1AB2, EcContinent::NONE },
            ...
            { EcScript::ZDIA, 2 }, MapType::SYM_PUNCT,
            EcScript::NONE, EcFont::FUNKY },
    // Balinese OK
    { 0x1B00, 0x1B7F, { 0x1B11, EcContinent::OCEAN },
            "Balinese",
            { EcScript::Bali, 0 }, MapType::OC_DEAD, EcScript::Bali },
    // Sundanese OK
    ...
    { 0x1DC0, 0x1DFF, { 0x1DD4, EcContinent::NONE },
            ...
            { EcScript::ZDIA, 1, }, MapType::SYM_PUNCT,
    ...
    { 0x20D0, 0x20FF, { 0x20E0, EcContinent::NONE },
            ...
            { EcScript::ZDIA, 'z' }, MapType::SYM_OTHER,
    ...
    { 0x27C0, 0x27EF, { L'⟈', EcContinent::NONE },
            ...
            { EcScript::ZMAT, 'A' }, MapType::SYM_OTHER,
            EcScript::NONE, EcFont::MATH },
    // Arrows A OK
    { 0x27F0, 0x27FF, { L'⟳', EcContinent::NONE },
            "Supplemental Arrows-A",
            { EcScript::ZARR, 'A' }, MapType::SYM_OTHER },
    // Braille OK
    { 0x2800, 0x28FF, { L'⠝', EcContinent::NONE },
            "Braille Patterns",
            { EcScript::Brai, 0 }, MapType::SYM_CODE, EcScript::Brai },
    // Arrows B OK
    ...
    { 0x2980, 0x29FF, { L'⧮', EcContinent::NONE },
            ...
            { EcScript::ZMAT, 'B' }, MapType::SYM_OTHER,
            EcScript::NONE, EcFont::MATH },
    // Supp math ops OK
    { 0x2A00, 0x2AFF, { L'⨔', EcContinent::NONE },
            "Supplemental Mathematical Operators",
            { EcScript::ZMAT, 1 }, MapType::SYM_OTHER,
            EcScript::NONE, EcFont::MATH },
    // Misc syms & arrows OK
    ...
    { 0x2DE0, 0x2DFF, { 0x2DF0, EcContinent::EUROPE },
            "Cyrillic Extended-A",
            { EcScript::Cyrl, 'A' }, MapType::EU_OTHER,
    ...
    { 0x3400, 0x4DBF, { L'㐾', EcContinent::CJK },
            ...
            { EcScript::Hani, 'A' }, MapType::CJ_HANI,
            EcScript::Hani, EcFont::NORMAL, Bfg::COLLAPSIBLE | Bfg::HAS_DESCRIPTION },
    // Yijing OK
    ...
    { 0xA720, 0xA7FF, { L'Ꝕ', EcContinent::EUROPE },
            "Latin Extended-D",
            { EcScript::Latn, 'D' }, MapType::EU_LATIN,
    ...
    { 0xA930, 0xA95F, { 0xA93B, EcContinent::OCEAN },
            "Rejang",
            { EcScript::Rjng, 0 }, MapType::OC_DEAD, EcScript::Rjng },
    // Hangul jamo A OK
    ...
    { 0x10000, 0x1007F, { 0x10002, EcContinent::EUROPE, {}, SvgHint { 7, 9 } },
            "Linear B Syllabary",
            { EcScript::Linb, 0 }, MapType::EU_OTHER_DEAD, EcScript::Linb },
    // Linear B hier OK
    { 0x10080, 0x100FF, { 0x100E0, EcContinent::EUROPE },
            "Linear B Ideograms",
            { EcScript::Linb, 1 }, MapType::EU_OTHER_DEAD, EcScript::Linb },
    // Aegean numbers OK
    ...
    { 0x10280, 0x1029F, { 0x10299, EcContinent::ASIA },
            "Lycian",
            { EcScript::Lyci, 0 }, MapType::AS_OTHER_DEAD, EcScript::Lyci },
    // Carian OK
    ...
    { 0x10300, 0x1032F, { 0x10300, EcContinent::EUROPE, {}, 2_hx },
            "Old Italic",
            { EcScript::Ital, 0 }, MapType::EU_OTHER_DEAD, EcScript::Ital },
    // Gothic OK
    { 0x10330, 0x1034F, { 0x10330, EcContinent::EUROPE },
            "Gothic",
            { EcScript::Goth, 0 }, MapType::EU_OTHER_DEAD, EcScript::Goth },
    // Old Permic OK
    { 0x10350, 0x1037F, { 0x10350, EcContinent::EUROPE, {}, SvgHint{ 3, 1 } },
            "Old Permic",
            { EcScript::Perm, 0 }, MapType::EU_OTHER_DEAD, EcScript::Perm },
    // Ugaritic OK
    { 0x10380, 0x1039F, { 0x10380, EcContinent::ASIA },
            "Ugaritic",
            { EcScript::Ugar, 0 }, MapType::AS_OTHER_DEAD, EcScript::Ugar },
    // Old Persian OK
    { 0x103A0, 0x103DF, { 0x103A2, EcContinent::ASIA },
            "Old Persian",
            { EcScript::Xpeo, 0 }, MapType::AS_OTHER_DEAD, EcScript::Xpeo },
    // Deseret OK
    { 0x10400, 0x1044F, { 0x10414, EcContinent::AMERICA, {}, 14_hx },
            "Deseret",
            { EcScript::Dsrt, 0 }, MapType::AM_DEAD, EcScript::Dsrt },
    // Shavian OK
    { 0x10450, 0x1047F, { 0x10459, EcContinent::EUROPE },
            "Shavian",
            { EcScript::Shaw, 0 }, MapType::EU_OTHER, EcScript::Shaw },
    // Osmanya OK
    { 0x10480, 0x104AF, { 0x10499, EcContinent::AFRICA },
            "Osmanya",
            { EcScript::Osma, 0 }, MapType::AF, EcScript::Osma },
    // Osage OK
    { 0x104B0, 0x104FF, { 0x104C8, EcContinent::AMERICA },
            "Osage",
            { EcScript::Osge, 0 }, MapType::AM, EcScript::Osge },
    // Elbasan OK
    ...
    { 0x10980, 0x1099F, { 0x10980, EcContinent::AFRICA },
            ...
            { EcScript::Mero, 0 }, MapType::AF_DEAD, EcScript::Mero },
    // Meroitic cursive OK
    ...
    { 0x11000, 0x1107F, { 0x1101C, EcContinent::ASIA, {}, SvgHint{ 6, 1 } },
            "Brahmi",
            { EcScript::Brah, 0 }, MapType::AS_BRAH_DEAD, EcScript::Brah },
    // Kaithi OK
    { 0x11080, 0x110CF, { 0x1108D, EcContinent::ASIA, {}, 7_hx },
            "Kaithi",
            { EcScript::Kthi, 0 }, MapType::AS_BRAH_DEAD, EcScript::Kthi },
    // Sora OK
    { 0x110D0, 0x110FF, { 0x110D0, EcContinent::ASIA },
            "Sora Sompeng",
            { EcScript::Sora, 0 }, MapType::AS_OTHER, EcScript::Sora },
    // Chakma OK
    ...
    { 0x11150, 0x1117F, { 0x11158, EcContinent::ASIA },
            "Mahajani",
            { EcScript::Mahj, 0 }, MapType::AS_BRAH_DEAD, EcScript::Mahj },
    // Sharada OK
    ...
    { 0x11280, 0x112AF, { 0x11284, EcContinent::ASIA },
            "Multani",
            { EcScript::Mult, 0 }, MapType::AS_BRAH_DEAD, EcScript::Mult },
    // Khudawadi OK
    { 0x112B0, 0x112FF, { 0x112BA, EcContinent::ASIA },
            "Khudawadi",
            { EcScript::Sind, 0 }, MapType::AS_BRAH, EcScript::Sind },
    // Grantha OK
    ...
    { 0x11400, 0x1147F, { 0x1140E, EcContinent::ASIA, {}, 2_hy },
            "Newa",
            { EcScript::Newa, 0 }, MapType::AS_BRAH, EcScript::Newa },
    // Tirhuta OK
    ...
    { 0x11800, 0x1184F, { 0x1180A, EcContinent::ASIA, {}, 1_hy },
            "Dogra",
            { EcScript::Dogr, 0 }, MapType::AS_BRAH, EcScript::Dogr },
    // Warang OK
    { 0x118A0, 0x118FF, { 0x118FF, EcContinent::ASIA },
            "Warang Citi",
            { EcScript::Wara, 0 }, MapType::AS_OTHER, EcScript::Wara },
    // Dives Akuru OK
    ...
    { 0x119A0, 0x119FF, { 0x119B4, EcContinent::ASIA, {}, SvgHint{ 9, 2 } },
            "Nandinagari",
            { EcScript::Nand, 0 }, MapType::AS_BRAH_DEAD, EcScript::Nand },
    // Zanabazar square OK
    { 0x11A00, 0x11A4F, { 0x11A0B, EcContinent::ASIA },
            "Zanabazar Square",
            { EcScript::Zanb, 0 }, MapType::AS_BRAH_DEAD,
    ...
    { 0x12000, 0x123FF, { 0x1202D, EcContinent::ASIA },
            "Cuneiform",
            { EcScript::Xsux, 0 }, MapType::AS_OTHER_DEAD, EcScript::Xsux },
    ...
    { 0x16E40, 0x16E9F, { 0x16E60, EcContinent::AFRICA, {}, SvgHint{ 3, ImbaY::BELOW_3 } },
            "Medefaidrin",
            { EcScript::Medf, 0 }, MapType::AF_DEAD, EcScript::Medf },
    // Miao OK
    ...
    { 0x1D200, 0x1D24F, { 0x1D200, EcContinent::EUROPE, {}, 1_hx },
            ...
            { EcScript::Grek, 3 }, MapType::SYM_CODE,
    ...
    { 0x1E7E0, 0x1E7FF, { 0x1E7FB, EcContinent::AFRICA, {}, SvgHint{ 14, ImbaY::ABOVE_4 } },
            "Ethiopic Extended-B",
            { EcScript::Ethi, 'B' }, MapType::AF,
            EcScript::Ethi, EcFont::NORMAL, Bfg::HAS_DESCRIPTION },
    // Mende Kikakui OK
    { 0x1E800, 0x1E8DF, { 0x1E800, EcContinent::AFRICA },
            "Mende Kikakui",
            { EcScript::Mend, 0}, MapType::AF_DEAD, EcScript::Mend },
    // Adlam OK
    ...
    { 0x1F300, 0x1F5FF, { 0x1F52B, EcContinent::NONE },
            ...
            { EcScript::ZSYM, 0 }, MapType::SYM_OTHER, },
    // Emoticons OK
    ...
    { 0x1F650, 0x1F67F, { 0x1F656, EcContinent::NONE },
            "Ornamental Dingbats",
            { EcScript::ZDIN, 1 }, MapType::SYM_OTHER,
            EcScript::NONE, EcFont::NOTO_SYMBOL2 },
    // Transport/map OK
    ...
    { 0x1F900, 0x1F9FF, { 0x1F98A, EcContinent::NONE },
            ...
            { EcScript::ZSYM, 1 }, MapType::SYM_OTHER,
            EcScript::NONE, EcFont::DINGBAT },
    ...
    { 0x20000, 0x2A6DF, { 0x20024, EcContinent::CJK },
            ...
            { EcScript::Hani, 'B' }, MapType::CJ_HANI,
            EcScript::Hani, EcFont::NORMAL, Bfg::COLLAPSIBLE | Bfg::HAS_DESCRIPTION },
    // CJK C OK
    { 0x2A700, 0x2B73F, { 0x2A704, EcContinent::CJK },
            "CJK Unified Ideographs Extension C",
            { EcScript::Hani, 'C' }, MapType::CJ_HANI,
            EcScript::Hani, EcFont::NORMAL, Bfg::COLLAPSIBLE | Bfg::HAS_DESCRIPTION },
    // CJK D OK
    { 0x2B740, 0x2B81F, { 0x2B742, EcContinent::CJK },
            "CJK Unified Ideographs Extension D",
            { EcScript::Hani, 'D' }, MapType::CJ_HANI,
            EcScript::Hani, EcFont::NORMAL, Bfg::COLLAPSIBLE | Bfg::HAS_DESCRIPTION },
    // CJK E OK
    ...
    { 0x2B820, 0x2CEAF, { 0x2B823, EcContinent::CJK },
            ...
            { EcScript::Hani, 'E' }, MapType::CJ_HANI,
            EcScript::Hani, EcFont::NORMAL, Bfg::COLLAPSIBLE | Bfg::HAS_DESCRIPTION },
    // CJK F OK
