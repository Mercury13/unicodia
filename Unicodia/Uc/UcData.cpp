...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Geor"sv, QFontDatabase::Georgian,
        ...
        u8"Достоверно неизвестно, когда создана грузиница и что было прототипом. "
                ...
                "отметается учёными."
            "<p>Грузинский язык безрегистровый, однако в Юникоде исторически существует четыре стиля письма, по порядку Юникода:<br>"
                ...
                "• нусхури{{-}}курсивный церковный минускул."sv,
                EcFont::GEORGIAN },
    ...
    { 0x1F000, 0x1F02F,
            ...
            u8"Азартная игра мацзян (часто через романизацию именуемая маджонг) изобретена в конце XIX{{_}}века, "
                ...
                "<p>Пасьянс изобрёл студент Броди Локард в 1981{{-}}он упал с батута, был полностью парализован и во время реабилитации "
                    ...
                    "Пасьянс был помесью двух китайских игр{{-}}«охоты на черепаху», игравшейся костями домино, и маджонга. "
