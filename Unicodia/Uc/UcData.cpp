...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Gran", QFontDatabase::Any,
        ...
        u8"Грантха{{-}}промежуточная ступень развития южной ветви [[ps:Brah|брахми]]. "
            ...
            "<p>Около 2010 не удалась попытка ввести грантху в Юникод в [[pt:unification|унификации]] с тамильской. "
                "Из-за поднявшегося шума решили разунифицировать письменности, "
                    "оставив только цифры, которые в современной грантхе совпадают с тамильскими."
            "<p>Обычная брахмийская абугида. "
                "[[pt:virama|Вирама]] крайне редка из-за тяги тамильского к открытым слогам "
    ...
    { "Grek", QFontDatabase::Greek,
        ...
        u8"Греческий сделан из [[ps:Phnx|финикийского]] без оглядки на раннегреческие системы{{-}}"
            ...
            u8"<p>Из греческого письма пошли [[ps:Latn|латиница]], [[ps:Cyrl|кириллица]], "
                "[[ps:Copt|коптский]] и, возможно, [[ps:Armn|армянский]] и [[ps:Runr|руны]].</p>" },
    ...
    { "Hani"sv, WS_HANI,       // Special rules for hieroglyphs, SimChi triggers them
        ...
        u8"<p>Первые пиктограммы относятся к VI{{_}}тысячелетию до н.э., их выцарапывали или рисовали краской, "
    ...
    { "Khar"sv, QFontDatabase::Any,
        ...
        u8"Кхароштхи (индобактрийское, кабульское письмо) применялось в Средней Азии и Афганистане до III{{_}}века. "
            "<p>Происходит из [[ps:Armi|арамейского]] и считается сестринским с [[ps:Brah|брахми]], потомков нет. "
...
constinit const uc::Block uc::blocks[] {
    ...
    { 0x1D100, 0x1D1FF,
            ...
            u8"<p>С X{{_}}века появилась нотная запись, похожая на современную. "
                ...
                "<p>Музыка{{-}}нетекстовая информация и потому вне внимания Юникода. "
