...
constinit const uc::Block uc::blocks[302] {
    ...
    { 0x2440, 0x245F,
            ...
            u8"<p>Оптическое и магнитное распознавание символов служит для автоматического ввода документов, "
                    "в первую очередь паспортов и банковских чеков. "
                    ...
                    "Эти шрифты (иногда в несколько искажённом виде) встречаются в фильмах и играх жанра «киберпанк»."
                "<p>В 1956 США продемонстрировали распознавание символов на магнитных чернилах. "
