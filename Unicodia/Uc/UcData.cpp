...
constinit const uc::Block uc::blocks[302] {
    ...
    { 0x1D400, 0x1D7FF,
            ...
            u8"<p>Математики обозначают различными шрифтами векторы (жирным), особые множества (жирным или ажурным), "
                    "пространства (рукописным), мощности множеств (готическим), "
                    "константы ({{sm|𝟘}} и {{sm|𝟙}} решётки, мнимые единицы {{sm|𝕚𝕛𝕜}} обозначают жирным или ажурным) и другое."
