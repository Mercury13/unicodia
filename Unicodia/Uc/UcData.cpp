      ...
      u8"игнорируемый символ", u8"default-ignorable character",
        ...
        "<p>Большинство игнорируемых символов являются [[pt:format|форматирующими]], но есть и непротяжённые [[pt:combining|метки]]. "
         ...
         "<p>• Символы, несущие дополнительную семантику{{-}}например, мягкий перенос, разъединитель графем, [[pk:E0000|тэги]].<br>"
            ...
            "• Тэги направления написания{{-}}напрмер, метки слева направо и справо налево.<br>"
            "• Невидимые символы, включающие и отключающие необязательные шрифтовые механизмы ([[pt:ligature|лигатуры]] и другие){{-}}"
                "например, соединитель нулевой длины (ZWJ), селекторы начертания (VS), заполнители [[ps:Hang|корейских]] чамо.<br>"
