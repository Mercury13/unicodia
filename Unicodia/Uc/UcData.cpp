...
constinit const uc::Version uc::versionInfo[] {
    ...
    { .unicodeName = u8"4.1", .date { 2005, Month::MAR }, .flags = Vfg::TEXT,
        .disun { .from = EcScript::Grek, .to = EcScript::Copt } },
    { u8"5.0",  { 2006, Month::JUL }, NO_FLAGS },
    { u8"5.1",  { 2008, Month::APR }, NO_FLAGS },
    { u8"5.2",  { 2009, Month::OCT }, NO_FLAGS },
    { u8"6.0",  { 2010, Month::OCT }, Vfg::FORCE_2COL, u8"0.6" },
    ...
    { u8"11.0", { 2018, Month::JUN }, Vfg::FORCE_2COL },
    ...
    { u8"14.0", { 2021, Month::SEP }, Vfg::FORCE_2COL },
    ...
    { u8"18.0", { 2026, Month::SEP }, Vfg::TEXT },
};
...
constexpr const uc::BreakInfo1 breakInfoProto[] {
    ...
    { .id = "AK",  .strength = uc::BreakStrength::BRAH, .flags = uc::BreakFg::SCRIPTS },
    { .id = "AP",  .strength = uc::BreakStrength::BRAH, .flags = uc::BreakFg::SCRIPTS },
    { .id = "AS",  .strength = uc::BreakStrength::BRAH, .flags = uc::BreakFg::SCRIPTS },
    { .id = "SA",  .strength = uc::BreakStrength::BRAH, .flags = uc::BreakFg::SCRIPTS },
    { .id = "VF",  .strength = uc::BreakStrength::BRAH, .flags = uc::BreakFg::SCRIPTS },
    { .id = "VI",  .strength = uc::BreakStrength::BRAH, .flags = uc::BreakFg::SCRIPTS },
    { .id = "AI",  .strength = uc::BreakStrength::SOFT, .flags = uc::BreakFg::SCRIPTS },
    { .id = "CJ",  .strength = uc::BreakStrength::SOFT, .flags = uc::BreakFg::SCRIPTS },
    { .id = "ID",  .strength = uc::BreakStrength::SOFT, .flags = uc::BreakFg::SCRIPTS },
    { .id = "H2",  .strength = uc::BreakStrength::SOFT },
    { .id = "H3", .altId = "H2", .strength = uc::BreakStrength::SOFT },
    { .id = "JL", .altId = "H2", .strength = uc::BreakStrength::SOFT },
...
const uc::Font* uc::Cp::font(const FontMatcher& matcher) const
{
    ...
    auto& blk = block();
    bool avoidBuiltin = blk.flags.have(Bfg::AVOID_BUILTIN)
            || (!blk.flags.have(Bfg::FORCE_BUILTIN) &&
