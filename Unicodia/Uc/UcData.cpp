...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Tglg", QFontDatabase::Any,
        ...
        u8"Обычная брахмийская абугида с гласной по умолчанию «а» и [[pt:virama|вирамой]]. "
            ...
            "<p>В 2021 закодировали новый звук «r»{{-}}одна версия называется «самбальская» и впервые замечена в 1895, "
                    "другая, хоть и называется «новой», не менее старая, и может носить точку в середине или черту в любом месте. "
                "В тагальских шрифтах эта буква закрепилась за позицией 170D. "
