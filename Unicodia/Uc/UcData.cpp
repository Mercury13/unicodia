...
const uc::ScriptType uc::scriptTypeInfo[static_cast<int>(EcScriptType::NN)] {
    ...
    { u8"абугида, монолитная <i>(слоговое, у сходных слогов похожие символы, "sv
        u8"символы в основном закодированы как монолитные\u00A0— как эфиопский."sv },
    { u8"абугида, сборная <i>(слоговое, у сходных слогов похожие символы, "sv
        u8"кодируется по-алфавитному, из согласного и метки-огласовки\u00A0— как деванагари)</i>"sv },
...
const uc::Script uc::scriptInfo[static_cast<int>(uc::EcScript::NN)] {
    ...
    { "Hani"sv, EcScriptType::HIEROGLYPH, EcLangLife::ALIVE, EcWritingDir::LTR_CJK,
        ...
        u8"<p>Первые пиктограммы относятся к VI\u00A0тысячелетию до н.э., впоследствии они видоизменились под письмо кистью и тушью. "sv
                ...
                u8"законсервировали архаичную письменность. В III\u00A0веке иероглифы проникли в Японию.</p>"sv
