...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Geor"sv, QFontDatabase::Georgian,
        ...
        u8"Достоверно неизвестно, когда создана грузиница и что было прототипом. "
                ...
                "отметается учёными."
            "<p>Грузинский язык безрегистровый, однако в Юникоде исторически существует четыре стиля письма, по порядку кодов:<br>"
                ...
                "• мтаврули{{-}}«заглавная» версия обычного грузинского без выносных элементов;<br />"
...
constinit const uc::Block uc::blocks[] {
    ...
    { 0x1C90, 0x1CBF,
            ...
            u8"''Мтаврули''{{-}}заглавная форма стандартного грузинского письма ''мхедрули''. "
                ...
                "<p>Данный блок добавил грузинскому языку регистр букв: строчные{{-}}мхедрули, заглавные{{-}}мтаврули. "
