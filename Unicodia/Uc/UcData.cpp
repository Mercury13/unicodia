...
constinit const uc::Category uc::categoryInfo[static_cast<int>(uc::EcCategory::NN)] {
    ...
    { UpCategory::LETTER,       "Ll"sv,     u8"Буква/строчная"sv,
            u8"Письмо «[[pt:minuscule|минускул]]», появившееся в раннее средневековье для экономии дорогого пергамента, "sv
...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Brah", QFontDatabase::Any,
        ...
        u8"санскрит, пали, праиндийские языки"sv,
        u8"Никто не знает, когда и откуда брахми произошёл{{-}}обычно считают, что из [[ps:Armi|арамейского]] "
            ...
            "<p>Юникод не различает брахми по времени и месту; большинство шрифтов близки к геометричным надписям Ашоки. "
                "К V{{_}}веку брахми трансформировалось в две крупных ветви:<br>"
                    "• северная (=гупта, позднее брахми, северное брахми) → [[ps:Shar|шарада]], [[ps:Sidd|сиддхаматрика]], "
    ...
    { "Cher"sv, QFontDatabase::Any,
        ...
        u8"Чероки", u8"1821",
        u8"чероки",
        u8"<p>Будущий вождь Секвойя, изобретатель азбуки чероки, был неграмотен, но брал символы из имевшихся книг{{-}}потому они значат "
    ...
    { "Chrs"sv, QFontDatabase::Any,
        EcScriptType::CONSONANT, EcLangLife::HISTORICAL, EcWritingDir::SOGDIAN, EcContinent::ASIA_INDIAN,
        u8"Хорезмийский", u8"550 до н.э."sv,
        u8"хорезмийский",
        u8"<p>Язык использовался в Хорезме в районе Амударьи до XIII{{_}}века, постепенно заменяясь персидским. "
    ...
    { "Diak"sv, QFontDatabase::Any,
        ...
        u8"Развился на Мальдивских островах из [[ps:Gran|грантхи]] и существовал до XVIII{{_}}века, а на некоторых островах и до XX. "
                    ...
                    "С переходом в ислам (1153) появился собственно ''дивес-акуру''. "
                "В начале XVIII{{_}}века по указу султана был заменён [[ps:Thaa|таной]]."
    ...
    { "Geor"sv, QFontDatabase::Georgian,
        ...
        u8"Достоверно неизвестно, когда создана грузиница и что было прототипом. "
            ...
            "<p>Грузинский язык безрегистровый, однако в Юникоде исторически существуют четыре стиля письма, по порядку кодов:<br>"
                ...
                "• нусхури{{-}}курсивный церковный [[pt:minuscule|минускул]]."sv,
                EcFont::GEORGIAN },
    ...
    { "Khar"sv, QFontDatabase::Any,
        ...
        u8"Письменность применялась в Средней Азии и Афганистане до III{{_}}века. "
            "<p>Происходит из [[ps:Armi|арамейского]] и не является потомком [[ps:Brah|брахми]], "
                    "но обладает всеми свойствами брахмийской абугиды, "
                    "даже имеется около 30 [[pt:ligature|лигатур]] из сдвоенных согласных. "
                "Разве что написание справа налево:<br>"
                    "{{_}}{{_}}{{_}}{{_}}ка {{sm|𐨐}} + и {{sm|◌𐨁}} = ки {{sm|𐨐𐨁}}<br>"
                    "{{_}}{{_}}{{_}}{{_}}ка {{sm|𐨐}} + вирама {{sm|◌𐨿}} = к {{sm|𐨐𐨿}}<br>"
                    "{{_}}{{_}}{{_}}{{_}}ка {{sm|𐨐}} + вирама {{sm|◌𐨿}} + та {{sm|𐨟}} = кта {{sm|&#68127;&#68112;&#68159;}}"
            "<p>''(В «Юникодии» почему-то нарисовало правильный знак через та+ка+вираму, "
    ...
    { "Latn"sv, QFontDatabase::Latin,
        ...
        u8"<p>Латиница{{-}}[[ps:Grek|древнегреческое]] письмо, адаптированное около VII{{_}}в.{{bc}} "
            ...
            "<p>В средние века к латинице добавились буквы J, V и W. [[pt:minuscule|Минускульное]] письмо, изобретённое для экономии "
                "дорогого пергамента, превратилось в строчные буквы.</p>"
    ...
    { "Phnx"sv, QFontDatabase::Any,
        ...
        u8"Хоть не финикийский, а [[ps:Ugar|угаритский]] алфавит считается первым расшифрованным консонантным "
...
constinit const uc::Term uc::terms[] {
    ...
    { "vyaz", EcTermCat::WRITING_STYLE,
      u8"вязь", {},
        u8"Нелинейный стиль письма, используемый для экономии материала: "
