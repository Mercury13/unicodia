...
constinit const uc::Script uc::scriptInfo[static_cast<int>(uc::EcScript::NN)] {
    ...
    { "Guru"sv, QFontDatabase::Gurmukhi,
        ...
        u8"<p>С X века в Пенджабе использовалась письменность шарада, плохо отвечавшая местному языку. Новую письменность придумал "
            ...
            "<p>Гласная по умолчанию «а», остальные добавляются огласовками: {{sm|ਕ}}=ка, {{sm|ਕਿ}}=ки. "
                "В безударных слогах «а» сильно редуцировалась, а в конце слов не читается вообще{{-}}"
                "потому вирама пенджабскому не нужна, однако встречается в санскритских текстах. "
