...
constinit const uc::Block uc::blocks[302] {
    ...
    { 0x1D360, 0x1D37F,
            ...
            u8"<p>Палочками учат считать детей. "
                ...
                "<p>Также в этом диапазоне есть два европейских счётных символа, чаще всего ассоциируемых с тюрьмой."sv },
    { 0x1D400, 0x1D7FF,
    ...
    { 0x1FB00, 0x1FBFF,
            ...
            u8"<p>Символы с разных компьютеров и систем 1970-х и 80-х: Amstrad CPC, Mattel Aquarius, Atari (ST, 400 и 800), "
                    "Tandy/RadioShack TRS-80 (Mark 1 и Color), Oric ''(малоизвестного британского компьютера)'', "
                    "MouseText ''(Apple IIc и более поздних)'', TI-99/4A, TRS-80, Commodore ''(PET и 64)'', Sinclair ''(ZX80 и 81)'', "
                    "телетекста и Minitel ''(французской терминальной службы)''. "
                ...
                "<p>Из-за политики Консорциума не включать товарные знаки в блоке отсутствуют два яблока Apple. "
                    ...
                    "что блоки псевдографики не стыкуются с блоками старых символов."sv },
    { 0x20000, 0x2A6DF,
