...
constinit const uc::Script uc::scriptInfo[static_cast<int>(uc::EcScript::NN)] {
    ...
    { "Laoo"sv, QFontDatabase::Lao,
        ...
        u8"<p>Лаосский алфавит стандартизирован в XIV веке. Как и тайский, происходит из кхмерского. "
                "После реформы, сделанной коммунистами в 1960-е, исчезли гласная по умолчанию и знак вирамы. Однако источники упорно "
                "продолжают считать лаосский абугидой.</p>"
            "<p>Между словами не ставятся пробелы. Как и в тайском, буквы называются подходящими словами: "
                "{{sm|ບ}} называется «бо-бэ» или просто «бэ» (козёл).</p>"
