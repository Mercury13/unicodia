    ...
    { 0x2070, 0x209F,
            ...
            u8"<p>Блок содержит надстрочные и подстрочные буквы, знаки и цифры, применяемые в математике и фонетике. "
                "<p>Ещё до распространения интернета выяснилось: бездумное копирование текста может привести "
                    ...
                    "К тому же нарисованные типографом индексы обычно качественнее, чем синтезированные редактором документов{{-}}"
                        "так, в шрифте ''Cambria'', используемом в «Юникодии» для Windows, индексы низкие, жирные и широкие." },
    // Curr symbols OK
    { 0x20A0, 0x20CF,
