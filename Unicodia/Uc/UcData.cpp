...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Deva"sv, QFontDatabase::Devanagari,
        ...
        "<p>Каждый символ означает слог с гласной «а». Чтобы отобразить другие слоги, надо добавить огласовку: "
                ...
                "Чтобы получить простую согласную, надо добавить знак «вирама» («остановка»): к {{sm|क्}}.</p>"sv,
                EcFont::DEVANAGARI },
...
constinit const uc::Block uc::blocks[302] {
    ...
    { 0x2070, 0x209F,
            ...
            u8"<p>Блок содержит надстрочные и подстрочные буквы, знаки и цифры, применяемые в математике и фонетике. "
                ...
                "<p>К тому же нарисованные типографом индексы обычно качественнее, чем синтезированные редактором документов."sv },
    // Curr symbols OK
    { 0x20A0, 0x20CF,
    ...
    { 0xFE00, 0xFE0F,
            ...
            u8"<p>Чаще всего (например, в браузерах) тот или иной вариант написания символа включают, выбирая другой шрифт "
                ...
                "<p>[[pop_scr:Latn|Латиница]], [[pop_scr:Mymr|бирманский и ещё несколько письменностей используют VS1. "
                    "[[pop_scr|Hani|Китайские иероглифы]] используют VS1…VS3. Эмодзи можно сделать цветными (VS16) "
      ...
      u8"брахмийская абугида"sv, u8"Brahmic abugida"sv,
        u8"<p>Исследователи расходятся в определении [[pop_term:abugida|абугиды]]. "
            ...
            "<p>Особенности брахмийских абугид:<br>"
                ...
                "• ''могут'' быть [[pop_term:ligature|лигатуры]] из нескольких согласных{{-}}деванагари {{sm|क्ष}} кса. "
