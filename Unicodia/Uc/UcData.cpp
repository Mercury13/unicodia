...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Arab", QFontDatabase::Arabic,
        ...
        u8"Арабский", Dating::century(7, u8"в современном виде"),
    ...
    { "Hani", WS_HANI,       // Special rules for hieroglyphs, SimChi triggers them
        ...
        u8"Первые пиктограммы относятся к VI{{_}}тысячелетию до н.э., их выцарапывали или рисовали краской, "
            ...
            "<p>А для Китая иероглифы вышли боком: нет стандартного произношения, навязываемого грамотными. "
                "Потому китайский язык раздроблен на диалекты, и ввести фонетическое письмо пока невозможно.",
                EcFont::CJK },
    ...
    { "inclusion", EcTermCat::OTHER,
      u8"инклюзивность и разнообразие", u8"inclusion and diversity",
        u8"Один из принципов [[pt:emoji|эмодзи]], появившийся, впрочем, не сразу. "
                ...
                "Так, от семей разного расового состава отказались потому, что будут тысячи глифов."
            ...
            "<p>Большинство эмодзи бесполы; пол при желании добавляется как {{em|🧙}}+ZWJ+{{em|♂}}."
            "<p>Отдельные старые эмодзи существуют в мужской и женской версии: {{em|🤴}}{{_}}принц, {{em|👸}}{{_}}принцесса."
