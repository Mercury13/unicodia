...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Xsux"sv, QFontDatabase::Any,
        ...
        u8"Изначально (≈3500{{bc}}) на глине писали хозяйственные документы (10 коров), но к 3200 появились иероглифы, "
            ...
            "<p>Многотысячелетняя клинопись хорошо сохранилась в пустынях Персии и Ирака, и к 1800 расшифровали слово «царь». "
                ...
                "В 1836 Эжéн Бюрнýф, догадавшись, что одна из табличек{{-}}список сатрапий Дария, расшифровал почти весь алфавит. "
                "К 1900 расшифровали все известные языки."sv,
                EcFont::CUNEIFORM },
