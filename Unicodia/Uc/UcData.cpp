    ...
    { "Diak", QFontDatabase::Any,
        ...
        u8"Развился на Мальдивских островах из [[ps:Gran|грантхи]] и существовал до XVIII{{_}}века, а на некоторых островах и до XX. "
            ...
            "<p>Гласная по умолчанию «а», заменяется на другую [[pt:combining|метками]]-огласовками, "
                ...
                "Прикреплённая к гласной вирама означает альтернативное звучание гласной «у» и гортанную смычку. "
                "Вторая вирама служит для стыков согласных{{-}}две буквы записываются без промежутка "
                    "(также существует 13 [[pt:ligature|лигатур]] вроде «ста»). "
                "Обычная вирама там, где нужны слепленные согласные{{,-}}альтернативное «у». "
                "Начальные гласные{{-}}отдельные буквы в ''эвела'' и огласовки на U+11925 в ''дивес''.<br>"
