...
constinit const uc::Script uc::scriptInfo[static_cast<int>(uc::EcScript::NN)] {
    ...
    { "Guru"sv, EcScriptType::ABUGIDA_BRAHMI, EcLangLife::ALIVE, EcWritingDir::LTR,
        ...
        u8"пенджабский"sv,
        u8"<p>С X века в Пенджабе использовалась письменность шарада, плохо отвечавшая местному языку.</p>"
            "<p>Письменность придумал сикхский гуру Ангад, один из основателей религии. Он основывал школы, где учились родному пенджабскому, "
                "а не классическому санскриту, и общественные столовые, где все сидели вместе, независимо от индуистской касты.</p>"
            "<p>Название означает «из уст гуру». По устройству и представлению в Юникоде похожа на деванагари. "
                "Гласная по умолчанию не «а», как в деванагари, а редуцированное «ə».</p>"
            u8"<p>Вирама пенджабскому языку не нужна, однако встречается в санскритских текстах. Чтобы начать слово с гласной, "
                "огласовки приделывают к нулевой согласной (для разных гласных разной), подобные начальные гласные закодированы "
                "монолитными символами.</p>"sv },
