...
constinit const uc::ScriptType uc::scriptTypeInfo[static_cast<int>(EcScriptType::NN)] {
    ...
    { u8"абугида <i>(слоговая, у сходных слогов похожие символы)</i>, "sv
        u8"кодируется по-алфавитному, из согласного и метки-огласовки, как тана"sv },
    { u8"абугида <i>(слоговая, у сходных слогов похожие символы)</i>, "sv
...
constinit const uc::Block uc::blocks[N_BLOCKS] {
    { 0x0000, 0x007F,
            "Basic Latin", u8"Базовая латиница",
            u8"<p>128 символов базовой латиницы совпадают с ASCII\u00A0— американской семибитной кодировкой, ставшей основой для большинства "
                ...
                "<p>Управляющие символы, если те не задействованы в программе, часто служат пользовательскими: "
                    "разного рода символы подстановки, пустое место в базе данных, отличающееся от пустой строки, и т.д.</p>" },
    { 0x0080, 0x00FF,
            "Latin-1 Supplement", u8"Латиница-1",
            u8"<p>Этот диапазон совпадает с однобайтовой кодировкой ISO 8859-1, появившейся в 1987 году и расширяющей ASCII до европейских языков.</p>"
                ...
                "<p>Среди букв видны символы × и ÷, изначально там должен быть Œœ.</p>" },
    { 0x0100, 0x017F,
    ...
    { 0x0250, 0x02AF,
            ...
            u8"<p>Международный фонетический алфавит на основе латинского используется языковедами, логопедами, певцами и актёрами, "
                ...
                "<p>Оперные певцы часто поют на чужом языке, и их способность читать знаки транскрипции часто используется составителями "
                    ...
                    "как «Янни».</p>"
                "<p>А ещё символы МФА позволяют перевернуть текст шутки ради.</p>" },
    { 0x02B0, 0x02FF,
            "Spacing Modifier Letters", u8"Протяжённые модификаторы букв",
            u8"<p>Протяжённые модификаторы букв используются в фонетике и языкознании, чтобы передать тоны, длину, мягкость и условные звуки: "
                ...
                "<p>Также в этом блоке есть протяжённые копии диакритических меток.</p>" },
    { 0x0300, 0x036F,
