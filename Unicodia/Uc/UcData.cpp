...
constexpr auto CT_CONTROL =
    u8"<p>В первые годы, когда часто требовалось повторить сессию обмена вручную (перфоратором или консолью), "
        ...
        "<p>Другие интересные команды:"
         "<p>• звонок 07{{-}}терминал или принтер привлекает внимание оператора. "
                "Сейчас обычно через звуковую плату и без приостановки печати;<br>"
            "• вкл/выкл альтернативный регистр 0E/0F{{-}}включает другой цвет ленты, другой набор символов принтера;<br>"
        ...
        "<p>Все 65 символов, прозванные управляющими, исторические. "
            "Символы, управляющие отображением текста, называются [[pt:format|форматирующими]]."sv;
    ...
    { "ligature", TermCat::CHAR_CLASS,
      u8"лигатура"sv, u8"ligature"sv,
        u8"<p>Лигатура{{-}}это несколько символов в одном:"
            ...
            "<p>Все лигатуры{{-}}[[pt:spacing|протяжённые]] символы."sv },
    { "space", TermCat::CHAR_CLASS,
      u8"пробел"sv, u8"space character"sv, CT_SPACE },
    { "control", TermCat::CHAR_CLASS,
