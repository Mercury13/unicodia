...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Hung", QFontDatabase::Any,
        ...
        u8"Неизвестно, как венгерские [[pt:runes|руны]] связаны с [[ps:Orkh|тюркскими]]: "
    ...
    { "Orkh", QFontDatabase::Any,
        ...
        u8"Русские исследователи начали собирать информацию ещё с Петра{{_}}I, письмена сразу же сравнили с [[ps:Runr|германскими рунами]], "
                ...
                "Финны поспешили приписать [[pt:runes|руны]] своим предкам."
...
constinit const uc::Term uc::terms[] {
    ...
    { "runes", EcTermCat::WRITING_STYLE,
      u8"руны", u8"runes",
        u8"Угловатое письмо, приспособленное для вырезания на твёрдом материале. "
                "В{{_}}фэнтези распространены «руны», написанные жирным пером или кистью{{-}}это по{{_}}определению не{{_}}руны."
        u8"<p>Юникод знает три рунических письменности: [[ps:Runr|англо-германские]], "
                    "[[ps:Orkh|тюркские]] и [[ps:Hung|венгерские]]. "
                "Не{{_}}закодированы булгарские руны из-за скудости материала. "
                "Дохристианские письменности славян иногда называют рунами, и материала по ним ещё меньше. "
                "На руны похож [[ps:Rjng|реджанг]]." },
