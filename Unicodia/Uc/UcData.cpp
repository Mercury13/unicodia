...
constinit const uc::Script uc::scriptInfo[static_cast<int>(uc::EcScript::NN)] {
    ...
    { "Thaa"sv, QFontDatabase::Thaana,
        ...
        u8"<p>Письменная культура пришла на Мальдивские острова вместе с буддизмом, появилось письмо ''эвела акуру'' на основе сингальского. "
                "Самая старая надпись датируется VII—VIII веком. В 1153 году некто Мухаммад ул-Абдалла провозгласил себя султаном и "
                "обратил мальдивцев в ислам; к XIV веку письмо видоизменилось в ''дивес акуру'' и сменило направление на обратное. "
                "В 1703 году султан Ибрахим{{_}}III заменил старую графику новой{{-}}<i>габули таной</i> (стандартным письмом).</p>"
