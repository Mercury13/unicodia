...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Tagb", QFontDatabase::Any,
        ...
        u8"Восходит к [[ps:Brah|брахми]] и родственная с [[ps:Tglg|тагальской]]. Осталось не более 25000 людей, говорящих на этих языках."sv,
                EcFont::TAGBANWA },
    // Takri OK, W10 none → installed Google Noto
    { "Takr"sv, QFontDatabase::Any,
        EcScriptType::ABUGIDA_BRAHMI, EcLangLife::DEAD, EcWritingDir::LTR, EcContinent::OCEAN,
        u8"Такри", u8"≈XVI век",
    ...
    { "abjad", EcTermCat::SCRIPT_CLASS,
      u8"консонантная письменность, абджад", u8"consonant script, abjad",
        u8"Письменность, где записываются только согласные звуки. "
            ...
            "• Различия сглаживаюся не только в пространстве, но и во времени{{-}}вековые надписи лучше отвечают современному языку.<br>"
            "• Такое письмо просто короче, что удобно при плохом качестве «бумаги» и чернил." },
