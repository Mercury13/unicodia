    ...
    { "vyaz", EcTermCat::WRITING_STYLE,
      u8"вязь", {},
        u8"Нелинейный стиль письма, используемый для экономии материала: "
                ...
                "Распространён в [[ps:Cyrl|кириллице]] (надписи на иконах), [[ps:Arab|арабице]] (террористические флаги)."
    ...
    { "cursive", EcTermCat::WRITING_STYLE,
      u8"курсив, беглое письмо", u8"cursive",
        u8"Стиль письма, когда нужно быстро написать что-то, особенно хрупким гусиным пером. "
            ...
            "<p>Не путать со стенографией ''(shorthand)'', когда специально обученный писец успевает за речью, "
                    "принося при этом определённые жертвы: разлинованная бумага, расшифровка в спокойной обстановке…" },
