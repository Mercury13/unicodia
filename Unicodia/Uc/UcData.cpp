...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Marc", QFontDatabase::Any,
        ...
        u8"Шангшунский{{-}}вымерший сино-тибетский язык, на котором писали минимум пятью разными письменностями. "
            ...
            "<p>Слоги строятся так: к основной согласной крепятся дополнительные, а ко всему этому{{-}}огласовка. "
                "Например, {{sm|𑱺𑲕𑲱}} ''ting''{{-}}«синий». "
                "Так это пишется и в Юникоде: Ta +{{_}}subjoined Nga +{{_}}I. "
    ...
    { "Telu", QFontDatabase::Telugu,
        ...
        u8"Как и большинство других письменностей Юго-Восточной Азии, произошла из [[ps:Brah|брахми]]. "
            ...
            "<p>[[pt:virama|Вирама]] в явном виде используется только при записи санскрита{{-}}"
    ...
    { 0x1CF00, 0x1CFCF,
            ...
            u8"Знáменное, или крюковое пение{{-}}одноголосое православное пение. "
                ...
                "<p>Древнейшие партитуры датируются XI{{_}}веком. "
                    ...
                    "Двоезнаменники{{-}}партитуры, записанные и знамёнами, и нотами{{-}}дали ключ к пониманию знаменной нотации. "
