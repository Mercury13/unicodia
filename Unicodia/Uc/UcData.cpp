...
const uc::ScriptType uc::scriptTypeInfo[static_cast<int>(EcScriptType::NN)] {
    ...
    { u8"код <i>(записывает символы другого языка, как шрифт Брайля)</i>"sv },
...
const uc::Script uc::scriptInfo[static_cast<int>(uc::EcScript::NN)] {
    ...
    { "Brai"sv, EcScriptType::CODE, EcLangLife::NOMATTER, EcWritingDir::NOMATTER,
        ...
        u8"<p>Шрифт Брайля\u00A0— точечный шрифт для слепых. В нём используются группы 2×3 точки с двоичным кодированием; иногда добавляется "
            ...
            "<p>Шрифт Брайля поставил реабилитацию слепых на промышленные рельсы: легко сделать устройства для тиснения Брайлем, "
