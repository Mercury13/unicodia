...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Arab"sv, QFontDatabase::Arabic,
        ...
        u8"<p>Письменность развилась из [[ps:Syrc|сирийской]]. Арабский язык тесно связан с исламом; на этом языке написан Коран (610–632). "
...
constinit const uc::Term uc::terms[] {
      ...
      u8"слоговая азбука"sv, u8"syllabic script"sv,
        u8"<p>Письменность, в которой каждая буква записывает слог из гласной и согласной. "
            ...
            "<p>Чтобы записывать стечения и одинокие согласные, есть несколько вариантов (возьмём для примера слово ''стол''):<br>"
                ...
                "• сделать такой символ, приделав к слогу [[ps:virama|умляут]]: сǎ+то+лǎ "
                ...
                "• придумать [[pt:ligature|лигатуры]]: сᵀо+?? (развитые брахмийские абугиды вроде [[ps:Deva|деванагари]]);<br>"
                "• отбросить конечную согласную: ??+то ([[ps:Linb|микенский]], [[ps:Buhd|бухид]])."sv },
      ...
      u8"абугида"sv, u8"abugida"sv,
        u8"<p>Исследователи не сходятся в определении абугиды, и самое широкое из них такое: "
            ...
            "<p>Абугидами '''являются у многих исследователей''' [[ps:Ethi|эфиопская]] и [[ps:Cans|канадская слоговая]] "
                    "письменности."
            "<p>Абугидами '''не являются ни в одном источнике''' [[ps:Hang|хангыль]], [[ps:Thaa|тана]], [[ps:Yiii|и]]."
      ...
      u8"ККЯ = китайский, корейский, японский"sv, u8"CJK = Chinese, Japanese, Korean"sv,
        u8"<p>Группа письменностей, восходящих к [[ps:Hani|китайским иероглифам]]. "
                "К ним относятся также слоговые [[ps:Kana|катакана]] и [[ps:Hira|хирагана]], и "
                    "[[pt:pseudoalphabet|псевдоалфавитный]] [[ps:Hang|хангыль]]."
      ...
      u8"лигатура"sv, u8"ligature"sv,
        u8"<p>Лигатура{{-}}это несколько символов в одном:"
            ...
            "<p>2. В шрифтовом деле{{-}}символ, означающий последовательность из нескольких [[pt:codepoint|кодовых позиций]]. "
                ...
                "Много таких лигатур в [[pt:brahmic|брахмийских абугидах]]."sv },
      ...
      u8"вирама"sv, u8"virama"sv,
        u8"<p>Вирама (санскрит «остановка»){{-}}знак в [[pt:brahmic|брахмийских]] абугидах, означающий «стереть гласную по умолчанию». "
            ...
            "<p>Некоторые языки пользуются вирамой нечасто. Например:<br>"
                "• используют [[pt:ligature|лигатуры]]{{-}}деванагари {{sm|क्ष}} кса. "
                ...
                "• вирама может быть единым целым с согласной{{-}}[[ps:Talu|новое письмо лы]]."sv },
    ...
    { "serialization", TermCat::SERIALIZATION,
      u8"сериализация"sv, u8"serialization"sv,
        u8"<p>Метод преобразования данных в цепочку ''кодовых единиц''{{-}}байтов для [[pt:utf8|UTF-8]], "
    ...
    { "utf8", TermCat::SERIALIZATION,
      u8"UTF-8"sv, {},
        u8"<p>'''Unicode transformation format, 8-bit'''{{-}}формат [[pt:serialization|сериализации]] Юникода в цепочку байтов. "
            ...
            "<p>Свойства UTF-8:<br>"
                "• [[pt:bom|Метка порядка байтов]] EF{{_}}BB{{_}}BF;<br>"
    ...
    { "utf16", TermCat::SERIALIZATION,
      u8"UTF-16"sv, {},
        u8"<p>'''Unicode transformation format, 16-bit'''{{-}}формат [[pt:serialization|сериализации]] Юникода в цепочку двухбайтовых слов. "
            ...
            "<p>Свойства UTF-16:<br>"
                "• [[pt:bom|Метка порядка байтов]] FE{{_}}FF для UTF-16BE (слова начинаются со старшего байта), "
                ...
                "• Обратная совместимость: текст в [[ps:bmp|базовой плоскости]] без пользовательских символов неотличим от UCS-2.<br>"
    ...
    { "bom", TermCat::SERIALIZATION,
      u8"метка порядка байтов"sv, u8"byte order mark"sv,
        u8"<p>Символ U+FEFF. Его можно (не обязательно) ставить в начале текстового файла, чтобы указать его формат. "
                ...
                "• 00{{_}}00{{_}}FE{{_}}FF{{-}}[[pt:utf32|UTF-32BE]] (как формат межпрограммного обмена встречается крайне редко);<br>"
