...
constinit const uc::Term uc::terms[] {
    ...
    { "number", EcTermCat::CHAR_CLASS,
      u8"числовой символ"sv, u8"number character"sv,
        u8"<p>Юникод делит числовые символы на три класса:<br>"
            "• десятичные позиционные цифры{{-}}как привычные ASCII-цифры 0…9, так и цифры других письменностей "
                "([[ps:Deva|деванагари]] ०…९);<br>"
            "• десятичные позиционные цифры, используемые в особых контекстах (например, в верхних/нижних индексах);<br>"
            "• прочие числовые символы: цифры недесятичных и непозиционных систем счисления (римские, эгейские), "
                "[[pt:precomposed|монолитные]] числа…"
