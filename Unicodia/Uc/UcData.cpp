...
constinit const uc::Term uc::terms[] {
    ...
    { "logical", EcTermCat::PRINCIPLES,
      u8"логический порядок"sv, u8"logical order"sv,
        u8"Юникод хранит символы в логическом порядке{{-}}который примерно соответствует порядку набора текста с клавиатуры "
                    "или произношения. "
    ...
    { "convertibility", EcTermCat::PRINCIPLES,
      u8"преобразуемость"sv, u8"convertibility"sv,
        u8"Юникод используется для обмена с другими стандартами текста{{-}}национальными, международными, "
                ...
                "Это позволяет преобразовывать из кодировки в кодировку через Юникод."
      ...
      u8"символы, не глифы"sv, u8"characters, not glyphs"sv,
        u8"Символ{{-}}единица смысла. Глиф{{-}}изображение, содержащееся в шрифте и выводимое на экран/печать."
            u8"<p>Символы и глифы соотносятся не 1:1. "
                ...
                "Но в кодировке всего две сотни символов, передающих ''смысл''."sv },
    { "universality", EcTermCat::PRINCIPLES,
      u8"универсальность"sv, u8"universality"sv,
        u8"Юникод разработан для людей разных языков и профессий: работающих в бизнесе, образовании, религии и науке, "
            ...
            "<p>За пределами Юникода лежат письменности, про которые мало что известно, чтобы надёжно закодировать символы, "
                    "письменности, чьи пользователи не пришли к де-факто стандарту, "
                    "и нетекстовые письменности."sv },
    { "unification", EcTermCat::PRINCIPLES,
      u8"унификация"sv, u8"unification"sv,
        u8"Юникод старается не дублировать символы. "
                ...
                "Точно так же одни и те же арабские знаки препинания используются а персидском и урду. "
    ...
    { "efficiency", EcTermCat::PRINCIPLES,
      u8"эффективность"sv, u8"efficiency"sv,
        u8"Юникод старается, чтобы эффективные реализации были реальны. В частности:"
             "<p>• В Юникоде нет переключаемых регистров. Это упрощает доступ и поиск.<br>"
                "• Основные формы кодирования{{-}}[[pt:utf8|UTF-8]] и [[pt:utf16|UTF-16]]{{-}}самосинхронизирующиеся. "
