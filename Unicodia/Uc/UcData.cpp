      ...
      u8"запрещённый символ"sv, u8"deprecated character"sv,
        u8"<p>Символ, чьё использование настоятельно не рекомендуется."
            ...
            "<p>Известны несколько случаев возврата символов в обиход.<br>"
                "• Блок тэгов{{-}}использовали для указания языка, вносили больше неразберихи, чем решали проблем. "
                    "Вернули для [[pt:emoji|эмодзи]] флагов государственных субъектов (например, Шотландии).<br>"
                "• 0340 и 0341 (метки нисходящего/восходящего тона). "
                    "С Юникода 5.2 находятся в просто нерекомендуемых."
