...
constinit const std::u8string_view uc::TX_NOCHAR =
    u8"<p>Этого символа никогда не будет в Юникоде. "
            "Его код можно использовать как код ошибки, знак подстановки, «утяжелитель» при сортировке "
            "или что-то другое, внутреннее для программы, перекодировать в UTF-8 или UTF-16."
        "<p>Этот символ нельзя использовать в межпрограммном обмене. "
            ...
            "неизвестным символом."
        "<p>Зарезервированы как отсутствующие 66 позиций: *FFFE и *FFFF во всех семнадцати плоскостях, "
            "а также FDD0…FDEF."sv;
