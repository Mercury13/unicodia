...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Khar"sv, QFontDatabase::Any,
        ...
        u8"Кхароштхи (индобактрийское, кабульское письмо) применялась в Средней Азии и Афганистане до III{{_}}века. "
            "<p>Происходит из [[ps:Armi|арамейского]], но уже обладает одним из свойств [[pt:brahmic|брахмийской абугиды]]{{-}}"
                        "гласная по умолчанию меняется огласовками. "
