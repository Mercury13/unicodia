...
constinit const uc::Block uc::blocks[302] {
            ...
            u8"<p>Оптическое и магнитное распознавание символов служит для автоматического ввода документов, "
                ...
                "<p>В 1956 США продемонстрировали распознавание символов на магнитных чернилах (MICR). "
                    ...
                    "Если видите квадратный шрифт, в котором часть вертикальных штрихов толстая "
                        "(например, на коробке приставки ''Magnavox Odyssey''){{-}}это потомок MICR."
    ...
    { 0x25A0, 0x25FF,
            ...
            u8"<p>Геометрические фигуры используются для маркировки кнопок, грубого рисования пользовательских интерфейсов. "
                    ...
                    "Символ {{sm|◌}} используется в Юникоде для маркировки комбинирующих знаков." },
    // Misc sym OK
    ...
    { 0x2600, 0x26FF,
            ...
            u8"<p>В этом разделе есть эмодзи, знаки из астрономии, астрологии, настольных игр, восточной эзотерики, "
                    "религии, политики и просто для украшения печатного текста."sv },
    // Dingbats OK
    /// @todo [term] Link to emoji
    { 0x2700, 0x27BF,
    ...
    { 0x1D100, 0x1D1FF,
            ...
            u8"<p>С X{{_}}века появилась нотная запись, похожая на современную. "
                    "Ноты были квадратными, потому что рисовались жирным пером, количество линий в строке варьировалось. "
                    "Современные ноты появились в XVII веке, с появлением равнотемперированного строя, "
                    "позволившего переносить музыку на другие инструменты, играть оркестрами."
                "<p>Юникод как таковой не умеет писать музыку. "
                    "Однако заманчиво использовать имеющиеся типографские движки для хранения нот и их частей, "
                        "чтобы упрощать нотное ПО, сокращать нотные PDF."
                "<p>В 2013 вышел открытый стандарт ''Standard Music Font Layout'' (SMuFL), расширяющий блок "
