...
constinit const uc::Term uc::terms[] {
    { "hiero", EcTermCat::SCRIPT_CLASS,
      u8"иероглифы"sv, u8"ideographic script"sv,
        u8"<p>Как говорил Артемий Лебедев, пиктограмма «стакан» означает стакан. "
            ...
            "<p>Иероглифы{{-}}это два шага вперёд от пиктографического письма: "
                "картинка может означать понятие, и упорядочены они по месту в языке, а не по отношению друг к другу. "
                "Если «охотник убил оленя копьём», то копьё рисуется последним, а не между охотником и оленем."
            ...
            "<p>Переход от иероглифов к [[pt:syllabic|слоговому письму]] прост: "
                "достаточно записать незнакомое слово подходящими односложными иероглифами."sv },
    ...
    { "other", EcTermCat::SCRIPT_CLASS,
      u8"прочие письменности"sv, {},
        u8"<p>Прочие виды письменностей{{-}}это коды ([[ps:Brai|шрифт Брайля]]), "
                "стенография ([[ps:Dupl|система Дюплойе]]), "
                "запись других видов информации, кроме устной речи (ноты, [[ps:Sgnw|жестовое письмо]])."
