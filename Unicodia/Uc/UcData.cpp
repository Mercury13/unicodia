...
constexpr auto CT_FORMAT =
    u8"<p>Используются в Юникоде для управления различными его алгоритмами:<br>"
            "• разбивают текст на строки: 00AD{{-}}мягкий перенос;<br>"
            "• участвуют в [[pt:ligature|лигатурах]] или, наоборот, разрывают их: 034F{{-}}разделитель графем,"
                "FE00{{-}}начертание 1;<br>"
            "• задают направление письма: 2066{{-}}изолировать участок, идущий слева направо."sv;
