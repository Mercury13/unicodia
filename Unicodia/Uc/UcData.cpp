...
constinit const uc::Block uc::blocks[] {
    ...
    { 0x1D200, 0x1D24F,
            ...
            u8"Про древних греков известно мало. "
                ...
                "<p>Для музыкантов и певцв были разные нотации, это позволяло писать одновременно слова, музыку и подсказки для певцов. "
    ...
    { 0x1FB00, 0x1FBFF,
            ...
            u8"<p>Символы с разных компьютеров и систем 1970-х и 80-х:<br>"
                ...
                "<p>В стандарт '''не вошли''':<br>"
                    ...
                    "• знаки прямой/инверсной заливки с Apple{{-}}у него [[pt:mono|знакоместо]] 7×8, и чтобы заливка не была клетчатой, "
                        "прямой символ чередуют с инверсным;<br>"
