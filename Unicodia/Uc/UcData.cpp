    ...
    { "bidi", EcTermCat::ALGORITHM,
      u8"двунаправленный текст"sv, u8"bidirectional text"sv,
        u8"<p>Текст, содержащий хотя бы один символ с написанием «справа налево». "
            ...
            "<p>1. Разбить текст на независимые участки."
            "<p>2. Разбить каждый участок на вложенные отрезки: вся строка считается отрезком «слева направо», в неё вкладываются "
