...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Adlm", QFontDatabase::Any,
        ...
        u8"Фулá или фульбе{{-}}кочевники-скотоводы, антропологически самые близкие в Чёрной Африке к европейцам "
            ...
            "<p>Алфавит придуман братьями Ибрагима и Абдулайе Барри, тогда ещё подростками, "
                "чтобы лучше передавать языки фулá, чем латиница или арабский. "
            ...
            "<p>До этого были ещё две неудачных попытки придумать письменность фулá, не{{_}}описанных в Юникоде: "
    ...
    { "Aghb", QFontDatabase::Any,
        ...
        u8"агванский ''(=гаргарский, язык Кавказской Албании)''",
        u8"Никакого отношения к балканской Албании страна не{{_}}имеет, и вообще самоназвание неизвестно: "
                ...
                "Алфавит, возможно, использовался и в XII{{_}}веке в языках-потомках. "
                "Поскольку страна захватывает современную Россию и Грузию, условно отнесена к Европе."
            "<p>Считается, что письменность создал Месроп Маштоц, создатель [[ps:Armn|армянского]] алфавита{{-}}впрочем, это не{{_}}так: "
                    "Маштоц жил 362–440, и непонятно, какова была его роль. "
                "Письменность с XV{{_}}века несколько раз открывали и забывали. "
                "В 1937 году советские арменоведы нашли полный алфавит. "
                "В 1948 при строительстве ГЭС раскопали раннехристианский храм VI{{_}}века с аутентичными надписями. "
    ...
    { "Ahom", QFontDatabase::Any,
        ...
        u8"Тайцы, переселившиеся в долину реки Брахмапутра, создали письменность на основе тогдашней индийской абугиды. "
                ...
                "Возрождается с 1954, в письменность добавлены десятичные цифры, не{{_}}имеющие исторического обоснования. "
                "Тоновая система тайско-ахомского языка полностью потеряна{{-}}письменность её не{{_}}передавала."
    ...
    { "Arab", QFontDatabase::Arabic,
        ...
        u8"Арабский", Dating::century(7, StdNote::MODERN_FORM), {},
        ...
        u8"Письменность развилась из [[ps:Armi|арамейской]] через [[ps:Syrc|сирийскую]] и/или [[ps:Nbat|набатейскую]]. "
                ...
                "Переписчики Корана и установили окончательный алфавит. "
    ...
    { "Armi", QFontDatabase::Any,
        ...
        u8"Имперский арамейский", Dating::crange(-10, -9), {},
        ...
        u8"На основе арамейского в Ахеменидской империи создали книжный язык, "
                ...
                "С завоеванием Персии Александром Македонским (330{{bc}}) началась фрагментация языка и дальнейшее формирование "
    ...
    { "Bamu", QFontDatabase::Any,
        ...
        u8"бамум ''(Камерун)''",
        u8"Письменность придумал Ибрагим Нджойя, султан Бамума (запад Камеруна). "
                "Было выпущено семь версий (A…G), начиная от иероглифов и заканчивая слоговой. "
                "Правда, алфавит Нджойи передавал не все тоны, и возникло много омографов. "
                "Пришедшие в 1918 французы выгнали Нджойю и перевели язык на [[ps:Latn|латиницу]], "
                    "но письмо продолжало ограниченно работать до смерти Нджойи в 1930-х. "
                "В 2007 начат проект по возрождению, прогресс незначителен. "
                "Более ранние художества Нджойи [[pk:16800|можно увидеть]] в дополнительных плоскостях Юникода."
            "<p>Изначально согласные глухие, добавление той же гласной делает согласную звонкой: "
                    "{{sm|ꚫ}} па + {{sm|ꚠ}} а = ба. "
                "Гласная после слога ставит другую гласную: {{sm|ꚫ}} па + {{sm|ꚧ}} о = по. "
                "Крышка над символом как-то изменяет слог{{-}}ставит гортанную смычку, "
                    "убирает носовую согласную, меняет гласную… "
                "Верхняя черта играет роль [[pt:virama|вирамы]], убирающей гласную из слога.",
                EcFont::BAMUM },
    ...
    { "Beng", QFontDatabase::Bengali,
        ...
        u8"Относится к восточной ветви индийского письма. "
            ...
            "<p>Бангладеш{{-}}одно из двух исламских государств с собственной письменностью "
                "(не{{_}}[[ps:Arab|арабской]], не{{_}}[[ps:Latn|латиницей]], не{{_}}[[ps:Cyrl|кириллицей]]). "
    ...
    { "Brah", QFontDatabase::Any,
        ...
        u8"Неизвестно, когда и откуда брахми произошёл{{-}}обычно считают, что из [[ps:Armi|арамейского]] "
            ...
            "<p>Письменности брахмийского происхождения сильно меняют графику символов и звук по умолчанию, но сохраняют все "
                    "эти особенности и называются «брахмийские абугиды»."
            "<p>Часто стечения согласных записываются столбиком из букв, в шрифте ''Noto'' это не реализовано (braahmii={{sm|𑀩𑁆𑀭𑀸𑀳𑁆𑀫𑀻}}), "
                    "но есть в шрифте ''Segoe UI Historic'', появившемся в Windows 10: "
                    "braahmii=<font face='Segoe UI Historic' size='+3'>𑀩𑁆𑀭𑀸𑀳𑁆𑀫𑀻</font>."
            "<p>Юникод не{{_}}различает брахми по времени и месту; большинство шрифтов близки к геометричным надписям Ашоки. "
    ...
    { "Brai", QFontDatabase::Any,
        ...
        u8"Шрифт Брайля{{-}}точечный шрифт для слепых. "
            ...
            "<p>Шрифт Брайля поставил реабилитацию слепых на промышленные рельсы: легко сделать устройство для тиснения Брайлем, "
                "он не{{_}}бросается в глаза, будучи выдавлен вместе с обычным текстом для зрячих или даже поверх него.",
                EcFont::SYMBOL },
    ...
    { "Bugi", QFontDatabase::Any,
        ...
        u8"Бугийская письменность, или лонтара{{-}}потомок [[ps:Brah|брахми]] и работает по тому же принципу. "
            ...
            "<p>Гласная по умолчанию «а»: {{sm|ᨀ}}=ка, {{sm|ᨀᨚ}}=ко. "
                ...
                "[[pt:virama|Вирамы]] нет: основные стечения согласных{{-}}отдельные буквы, остальные просто не{{_}}записываются. "
    ...
    { "Buhd", QFontDatabase::Any,
        ...
        u8"Используется мангиан{{-}}небольшой филиппинской народностью (8000 на 1991{{_}}год). "
            ...
            "<p>В языке всего 15 согласных и три гласных: «а» по умолчанию, «и» и «у» задаются огласовками. Начальные гласные{{-}}"
                "отдельные буквы. На стыках слогов могут появляться дополнительные согласные, они не{{_}}записываются: "
    ...
    { "Cari", QFontDatabase::Any,
        ...
        u8"Использовался с VII до I веков{{bc}} "
            ...
            "<p>Советский (тогда ещё) учёный Виталий Шеворошкин в 1960 показал, что письменность не{{_}}слоговая, а алфавитная. "
                ...
                "Некоторые символы всё ещё не{{_}}известны.",
                EcFont::HISTORIC },
    ...
    { "Chrs", QFontDatabase::Any,
        ...
        u8"Хорезмийский", Dating::century(2, StdNote::FIRST_KNOWN), {},
        ...
        u8"Язык использовался в Хорезме в районе Амударьи до XIII{{_}}века, постепенно заменяясь персидским. "
            ...
            "<p>У трёх арамейских букв из 22{{-}}''teth, sadhe, qoph''{{-}}нет аналогов в хорезмийском. "
                ...
                "Буквы в большинстве надписей не{{_}}соединены, реже соединялись там, где позволяет форма.",
            EcFont::CHORASMIAN },
    ...
    { "Cprt", QFontDatabase::Any,
        ...
        u8"Происходит из [[ps:Lina|линейного письма А]] через [[ps:Cpmn|кипро-минойскую]] (не путать!). "
                ...
                "Надписи IX–VIII{{_}}веков не{{_}}обнаружены, в дальнейшем письмо разделилось на два варианта: "
    ...
    { "Cyrl", QFontDatabase::Cyrillic,
        ...
        u8"Кириллица", Dating::ybefore(900), {},
    ...
    { "Deva", QFontDatabase::Devanagari,
        EcScriptType::ABUGIDA_BRAHMI, EcLangLife::ALIVE, EcWritingDir::LTR, EcContinent::ASIA,
        u8"Деванáгари", Dating::crange(1, 7), {},
        u8"хинди, санскрит и другие языки Индии",
        u8"Деванáгари (буквально «язык божественного города») развился из письма брахми и стал алфавитом для многих языков Индии. "
            ...
            "<p>Вирамы в деванагари редки и обычно встречаются в конце слов из-за [[pt:ligature|лигатур]]:<br>"
                "{{__}}ка {{sm|क}} + вирама {{sm|◌्}} + ша {{sm|ष}} = кша {{sm|क्ष}}"
            "<p>«Юникодия» использует заведомо старую версию шрифта ''Noto Serif Devanagari''. "
                "В действующем тексте лучше применять другие шрифты{{-}}например, "
                    "[[http://www.sanskritweb.net/itrans/index.html#SIDDHANTA|Siddhanta]].",
                EcFont::DEVANAGARI },
    ...
    { "Diak", QFontDatabase::Any,
        ...
        u8"Развился на Мальдивских островах из [[ps:Gran|грантхи]] и существовал до XVIII{{_}}века, а на некоторых островах и до XX. "
                    ...
                    "С переходом в ислам (1153) ''эвела'' трансформировался в ''дивес'', оставшись слева направо. "
    ...
    { "Dogr", QFontDatabase::Any,
        ...
        u8"Язык догров, индийской народности. Письменность позаимствована из [[ps:Takr|такри]], стандартизирована "
            ...
            "<p>Брахмийская абугида с гласной по умолчанию «ə» (в Юникоде условно названа «а»), "
                ...
                "К тому же в догри встречаются [[pt:ligature|лигатуры]], не{{_}}закодированные в данном шрифте. "
    ...
    { "Dsrt", QFontDatabase::Any,
        ...
        u8"В XIX{{_}}веке было множество попыток придумать фонетический алфавит для английского, "
            ...
            "<p>Алфавит намеренно не{{_}}содержит выносных элементов{{-}}это должно снизить износ шрифта. "
    ...
    { "Dupl", QFontDatabase::Any,
        ...
        u8"Система стенографии, придуманная французским священником Эмилем Дюплойе. "
            ...
            "<p>Слова пишутся одним росчерком, при этом письмо может уходить далеко вверх или вниз. "
                "Для этого нужен не{{_}}только шрифт, но и специальный типографский движок, "
    ...
    { "Egyp", QFontDatabase::Any,
        ...
        u8"Египетская письменность прошла обычный путь от пиктографического письма (слова изображаются наглядными рисунками) "
            ...
            "<p>Помимо иероглифов, были две не{{_}}внесённые в Юникод письменности:<br>"
    ...
    { "Elym", QFontDatabase::Any,
        ...
        u8"После военных поражений от Александра Македонского Персия прекратила своё существование. "
            ...
            "<p>Государство существовало с 147{{bc}} до 224, часто попадало под власть парфян "
                ...
                "Никаких знаков препинания, кроме пробела, не{{_}}известно. "
    ...
    { "Ethi", QFontDatabase::Any,
        ...
        u8"Эфиопская (гéэз)", Dating::century(4, StdNote::CUSTOM), u8"как абугида",
    ...
    { "Glag", QFontDatabase::Any,
        ...
        u8"Глаголица, по наиболее распространённому мнению, была составлена около 863 византийцами Кириллом и Мефодием "
                    ...
                    "чтобы не{{_}}оказаться под франками. "
    ...
    { "Gong", QFontDatabase::Any,
        ...
        u8"В 2006 в деревушке Гунджала обнаружили документы 1750{{_}}года. "
            ...
            "<p>Каждая буква означает слог с «а». "
                ...
                "Письмо не{{_}}различает длинное и короткое «э» и и «о», идут споры о введении новых букв. "
    ...
    { "Gran", QFontDatabase::Any,
        ...
        u8"Грантха{{-}}промежуточная ступень развития южной ветви [[ps:Brah|брахми]]. "
            ...
            "<p>Около 2010 не{{_}}удалась попытка ввести грантху в Юникод в [[pt:unification|унификации]] с тамильской. "
    ...
    { "Guru", QFontDatabase::Gurmukhi,
        ...
        u8"С X века в Пенджабе использовалась письменность [[ps:Shrd|шарада]], плохо отвечавшая местному языку. Новую письменность придумал "
                ...
                "а не{{_}}классическому санскриту, и общественные столовые, где все сидели вместе, независимо от индуистской касты."
            "<p>Гласная по умолчанию «ə» (в Юникоде условно названа «а»). "
                "Остальные гласные добавляются огласовками: {{sm|ਕ}}=кə, {{sm|ਕਿ}}=ки. "
                "В безударных слогах «ə» сильно редуцировалась, а в конце слов не{{_}}читается вообще, "
                ...
                "Потому вирама пенджабскому нужна на клавиатуре, но не{{_}}в{{_}}печати, однако встречается "
    ...
    { "Hani", WS_HANI,       // Special rules for hieroglyphs, SimChi triggers them
        ...
        u8"Первые пиктограммы относятся к VI{{_}}тысячелетию до н.э., их выцарапывали или рисовали краской, "
            ...
            "<p>В Китае, Тайване, Японии и Корее иероглифы отличаются, Юникод эти различия не{{_}}кодирует: тонкости написания передаются шрифтами, "
                "и даже если шрифт неверный, понятно, о чём речь."
            "<p>Вьетнам отказался от иероглифов в 1945. Северная Корея не{{_}}использует иероглифы, Южная использует крайне редко."
            "<p>Китайский язык всё ещё раздроблен на диалекты, и ввести фонетическое письмо невозможно.",
                EcFont::CJK },
    ...
    { "Hent", QFontDatabase::Japanese,
        ...
        u8"Хэнтáйгана{{-}}общее название устаревших знаков [[ps:Hira|хирáганы]], записанных крайне небрежно."
            "<p>Из [[ps:Hani|иероглифов]] произошла вспомогательная азбука манъёгана{{-}}роль играло не{{_}}изображение на иероглифе, "
                "а прочтение. К X{{_}}веку манъёгана уступила хирагане и [[ps:Kana|катакане]]. "
                "Какой-то системы не{{_}}было, потому существовали разные знаки для одного слога. "
    ...
    { "Hira", QFontDatabase::Japanese,
        ...
        u8"Около III{{_}}века японцы стали писать [[ps:Hani|китайскими иероглифами]]. "
                "Из них произошла вспомогательная азбука манъёгана{{-}}роль играло не{{_}}изображение на иероглифе, а прочтение. "
                "Хирáгана{{-}}не что иное, как очень небрежно записанная манъёгана."
            "<p>Женщины, которым не{{_}}было доступно образование, писали слоговой азбукой, и предпочитали не{{_}}рубленую "
    ...
    { "Kana", QFontDatabase::Japanese,
        ...
        u8"Около III{{_}}века японцы стали писать [[ps:Hani|китайскими иероглифами]]. "
                ...
                "роль играло не{{_}}изображение на иероглифе, а его прочтение. Манъёгана упростилась до катáканы."
    ...
    { "Khar", QFontDatabase::Any,
        ...
        u8"Кхароштхи (индобактрийское, кабульское письмо) применялось в Средней Азии и Афганистане до III{{_}}века. "
            ...
            "<p>Существуют непозиционные цифры, похожие на римские. "
                "Кхароштхи открыто в XIX{{_}}веке и довольно быстро расшифровано.",
                EcFont::KHAROSHTHI },
    // Khmer OK, fancy and inconsistent in W7/10, installed Google Noto *UI* because of umlauts
    { "Khmr", QFontDatabase::Khmer,
        EcScriptType::ABUGIDA_BRAHMI, EcLangLife::ALIVE, EcWritingDir::LTR, EcContinent::ASIA,
        u8"Кхмерский", Dating::year(611, StdNote::FIRST_KNOWN), {},
        ...
        u8"Как и другие языки Юго-Восточной Азии, произошёл из [[ps:Brah|брахми]]. "
            ...
            "<p>Между словами не{{_}}ставятся пробелы. "
    ...
    { "Khoj", QFontDatabase::Any,
        ...
        u8"Традиционно считается, что ходжки придумал Пир Садардин (XIV{{_}}век), посланный в Индию проповедовать ислам. "
            ...
            "<p>Брахмийская абугида с гласной по умолчанию «а», [[pt:virama|вирамой]] "
                    ...
                    "одна из которых за неимением согласной «ша» пишется через знак «нукта»:<br>"
                ...
                "{{__}}ка {{sm|𑈈}} + вирама {{sm|◌𑈵}} + са {{sm|𑈩}} + нукта {{sm|◌𑈶}} = кша {{sm|𑈈𑈵𑈩𑈶}}"
    ...
    { "Kits", QFontDatabase::Any,
        ...
        u8"Малое киданьское письмо", Dating::year(925), {},
        ...
        u8"Использовалось в государстве Ляо (северо-восточный Китай). "
                ...
                "Из 378 известных на 1987{{_}}год символов 125{{-}}иероглифы, 115{{-}}фонетические, остальные не{{_}}расшифрованы."
            "<p>Большое и малое письмо использовались параллельно, малое проще (большое{{-}}чисто иероглифическое). "
                "Киданьских книг не{{_}}сохранилось, только предметы и надписи на захоронениях знатных граждан, последняя{{-}}около 1200. "
    ...
    { "Lana", QFontDatabase::Any,
        EcScriptType::ABUGIDA_BRAHMI, EcLangLife::COMPETING, EcWritingDir::LTR, EcContinent::ASIA,
        u8"Ланна (тай-тхам)", Dating::year(1376, StdNote::FIRST_KNOWN), {},
        ...
        u8"Происходит из северотайского государства Ланна или Ланнатай (1296—1558)."
            "<p>Как и в других подобных письменностях, круглые очертания букв произошли из-за письма на пальмовых листьях "
                ...
                "Между словами не{{_}}ставятся пробелы. Гласные буквы бывают двух видов: независимые (в начале слова) и огласовки. "
            ...
            "<p>Говорящих на языке юан несколько миллионов, но с XX века не{{_}}многие грамотны в ланне, чаще пишут [[ps:Thai|тайским]] письмом.",
                EcFont::LANNA },
    ...
    { "Laoo", QFontDatabase::Lao,
        ...
        u8"Лаосский алфавит стандартизирован в XIV веке. Как и [[ps:Thai|тайский]], происходит из [[ps:Khmr|кхмерского]]. "
            ...
            "<p>В Юникоде для пустого места над меткой принят пунктирный кружок; лаосцы традиционно используют косой крест, "
                "в Юникод не{{_}}попавший. Иногда для этого используют [[ps:Latn|латинскую]] «x».",
                EcFont::LAO },
    // Latin OK, managed to modify
    { "Latn", QFontDatabase::Latin,
        EcScriptType::ALPHABET, EcLangLife::ALIVE, EcWritingDir::LTR, EcContinent::EUROPE,
        u8"Латиница", Dating::yapprox(-700), {},
        ...
        u8"Латиница{{-}}[[ps:Grek|древнегреческое]] письмо, адаптированное около 700{{bc}} "
    ...
    { "Linb", QFontDatabase::Any,
        ...
        u8"Достаточно точно известен момент утверждения на Крите греческой власти{{-}}1450{{bc}} "
            ...
            "<p>Витиеватая форма символов позволяет предположить, что писали на коже или папирусе, тем более линейным письмом А "
                ...
                "Письмо использовалось узкой кастой писцов, ориентировавшихся на грамматику минойского языка, а не{{_}}греческого. "
    ...
    { "Lyci", QFontDatabase::Any,
        ...
        u8"Алфавит придуман под влиянием [[ps:Phnx|финикийского]] и [[ps:Grek|греческого]]. "
    ...
    { "Lydi", QFontDatabase::Any,
        ...
        u8"Лидийский (сардийский)", Dating::crange(-8, -7), {},
        u8"лидийский ''(=сардийский, Малая Азия)''",
        u8"Алфавит близок к [[ps:Lyci|ликийскому]], произошёл из [[ps:Phnx|финикийского]]. "
                "Вытеснен [[ps:Grek|греческим]] около III{{_}}века{{bc}}, когда Лидию завоевал Александр Македонский."
    ...
    { "Mahj", QFontDatabase::Any,
        ...
        u8"Ещё один, как и [[ps:Kthi|кайтхи]], отголосок индийской кастовой системы{{-}}эта письменность использовалась банкирами "
            ...
            "<p>Письменность деградировала почти до [[pt:abjad|консонантной]]: согласная буква означает и «ка», и «ки», и «к». "
                ...
                "Многие из них плохо исследованы и потому всё ещё не{{_}}закодированы."
    ...
    { "Maka", QFontDatabase::Any,
        ...
        u8"Происходит из кави (старояванского), а оно из паллавы (ранней [[ps:Gran|грантхи]]). "
                ...
                "Когда письмо появилось{{-}}предмет споров, но оно не{{_}}древнее: "
                    "известная форма приспособлена к перу и бумаге, а не{{_}}пальмовым листьям. "
    ...
    { "Mlym", QFontDatabase::Malayalam,
        ...
        u8"Происходит из [[ps:Gran|грантхи]]. "
                ...
                "[[pt:virama|Вирама]] редка и обычно встречается в конце слов: "
                    ...
                    "а не{{_}}сверху вниз, как в похожих письменностях. "
    ...
    { "Nand", QFontDatabase::Any,
        ...
        u8"Происходит из нагари, промежуточной формы индийского письма. "
                ...
                "Если бы не{{_}}различия{{-}}разорванная черта, другие [[pt:ligature|лигатуры]] и цифры{{-}}"
                    "нанди- можно было бы считать разновидностью деванагари. "
                "Письмо использовалось до XIX{{_}}века."
            "<p>Гласная по умолчанию «а», заменяется на другую [[pt:combining|метками]]-огласовками. "
                "Все метки, включая [[pt:virama|вираму]], не{{_}}отрываются от букв. "
    ...
    { "Olck", QFontDatabase::Any,
        ...
        u8"Алфавит придумал в 1925 Рагхунатх Мурму. До этого пользовались [[ps:Beng|бенгальской]] письменностью, "
                ...
                "Сантальский язык австроазиатский, а не{{_}}индоевропейский, и алфавиты, основанные на брахми, подходили плохо. "
    ...
    { "Orkh", QFontDatabase::Any,
        ...
        u8"Русские исследователи начали собирать информацию ещё с Петра{{_}}I, письмена сразу же сравнили с [[ps:Runr|германскими рунами]], "
            ...
            "<p>Известно около 200 надписей VII–X{{_}}веков и несколько рукописей IX–X{{_}}веков. "
                ...
                "История кыргызов не{{_}}вполне понятна; известно только, что в XIII{{_}}веке они стали вассалами Чингисхана."
            "<p>Глиф {{sm|𐱇}} осенью 2021 заменили, в «Юникодии» пока старая версия.",
                EcFont::ORKHON },
    ...
    { "Orya", QFontDatabase::Oriya,
        ...
        u8"Ори́я (традиционно, но неверно считается однокоренным с ''арийцами'') развилась из [[ps:Sidd|сиддхаматрики]], "
            ...
            "<p>Есть мнение, что округлая форма букв сложилась, потому что писали на пальмовых листьях{{-}}чтобы не{{_}}разрезать лист "
            ...
            "<p>Гласная по умолчанию «а», убирается знаком [[pt:virama|вирамы]]: {{sm|କ}}=ка, {{sm|କି}}=ки, {{sm|କ୍}}=к. "
                "В языке ория, в отличие от других индийских, этот звук никогда не{{_}}убирается сам по себе, без вирамы. "
    ...
    { "Phag", QFontDatabase::Any,
        ...
        u8"[[ps:Mong|Монгольское]] письмо использовало [[ps:Ougr|уйгурский]] алфавит с минимальными изменениями. "
                ...
                "и эту задачу выполнил Пагба-лама (1235–1280), наставник Хубилая. "
                "Письмо внедрялось туго, уйгурский алфавит запрещали как минимум дважды. "
                "В 1368 году китайцы выбили монголов, письмо быстро забыли. "
                "Сейчас изредка употребляется в печатях монастырей Тибета и Бутана."
            "<p>В шрифтах письмо обычно рисуется повёрнутым на 90° влево, чтобы писать по строкам. "
                "Буквы пишутся одна за другой, как в обычной алфавитной записи. "
                "Буквы в слоге соединены, между слогами узкий пробел. "
                "Гласная «а» подразумевается по умолчанию и пишется, если она начальная.<br>"
                "{{__}}{{sm|ꡏꡡꡃ ꡣꡡꡙ}} = mongxol"
            "<p>Существовали три стиля: книжный (основной), "
                    "с печатей (имитировал старую китайскую каллиграфию, использовавшуюся в печатях) "
                    "и тибетский (похож на [[ps:Marc|марчхен]]).",
                EcFont::PHAGS_PA },
    ...
    { "Phlp", QFontDatabase::Any,
        ...
        u8"Очень беглое письмо, опознанное как промежуточная фаза письма пехлеви. "
            ...
            "<p>''Книжное пехлеви'', последняя форма письма, так и не{{_}}вошло в Юникод, для него оставлена дыра.",
    ...
    { "Runr", QFontDatabase::Runic,
        EcScriptType::ALPHABET, EcLangLife::HISTORICAL, EcWritingDir::LTR, EcContinent::EUROPE,
        u8"Руны", Dating::century(2, StdNote::FIRST_KNOWN), {},
        ...
        u8"Руны имеют специфическую угловатую форму, приспособленную для вырезания: вдоль и поперёк волокон дерево сопротивляется по-разному, "
                ...
                "Найдено около 5000 памятников рунического письма, самые старые относятся ко II{{_}}веку. "
    ...
    { "Sgnw", QFontDatabase::Any,
        ...
        u8"Систему придумала в 1974 танцовщица Валери Саттон на основе созданной двумя годами ранее системы записи танцев. "
                "Впоследствии она же придумала системы для записи пантомимы, других видов спорта (фигурного катания, каратэ…), "
                    "физических упражнений, языка тела людей и животных, которые, впрочем, не{{_}}были столь успешны."
            ...
            "<p>Хотя система не{{_}}является строго [[pt:universality|текстовой]]{{-}}положение жестов на странице ''играет'' роль{{-}}"
    ...
    { "Sidd", QFontDatabase::Any,
        ...
        u8"Средневековое североиндийское письмо, появившееся из [[ps:Brah|брахми]] и связанное с буддизмом. "
                ...
                "Между словами не{{_}}ставятся пробелы. "
    ...
    { "Sylo", QFontDatabase::Any,
        ...
        u8"По одной из теорий, письменность произошла из [[ps:Kthi|кайтхи]] и изобретена мусульманами. "
            ...
            "<p>Брахмийская абугида с гласной по умолчанию «о» и [[pt:virama|вирамой]] ''(хасанта)'': "
                    "{{sm|ꠇ}}=ко, {{sm|ꠇꠣ}}=ка, {{sm|ꠇ꠆}}=к. "
    ...
    { "Tale", QFontDatabase::Any,
        ...
        u8"Как и большинство других письменностей Юго-Восточной Азии, произошла из [[ps:Brah|брахми]]. "
            ...
            "<p>Пробелы пишутся между предложениями, но не{{_}}между словами. "
            ...
            "<p>Дайцев в Китае ≈500 тыс. (2001), но язык быстро заменяется китайским и потому отнесён к уязвимым. "
                "Ещё не{{_}}более 500 тыс. разбросано по другим странам, они пользуются в основном [[ps:Lana|ланной]].",
                EcFont::TAILE },
    ...
    { "Taml", QFontDatabase::Tamil,
        ...
        u8"Письменность произошла из [[ps:Brah|брахми]] через паллаву (старую [[ps:Gran|грантху]]). "
            ...
            "<p>Дравидийский Юг никогда не{{_}}покорялся мусульманам и даже создал шиваизм, особо ортодоксальную ветвь индуизма."
    ...
    { "Tang", QFontDatabase::Any,
        ...
        u8"Очень сложная иероглифическая система, существовавшая в тангутском царстве Си Ся (северо-западный Китай). "
            ...
            "<p>Как и у [[ps:Hani|китайцев]], у тангутов была развита каллиграфия, у одного иероглифа было до 4 форм. "
                "В Юникоде они закодированы одним символом, если не{{_}}встречаются в одном источнике. "
    ...
    { "Tfng", QFontDatabase::Any,
        ...
        u8"Происхождение староливийского письма неясно, обычно считают, что из [[ps:Phnx|финикийского]]. "
            ...
            "<p>В XX{{_}}веке из староливийского создали новую письменность, с написанием слева направо. Исламские государства "
    ...
    { "Tglg", QFontDatabase::Any,
        ...
        u8"Брахмийская абугида с гласной по умолчанию «а» и [[pt:virama|вирамой]]. "
            ...
            "<p>Испанские миссионеры (XVI{{_}}век) увидели, что островитяне поголовно грамотны, и сами стали учить их на байбайине. "
                "При этом не{{_}}сразу поняли, в каком направлении пишут: текст вырезали на бамбуковых дощечках, направляя нож от себя, "
    ...
    { "Ugar", QFontDatabase::Any,
        ...
        u8"Жившие в Передней Азии (современная Сирия) семиты не{{_}}хвастались экономической, культурной или военной мощью, "
            ...
            "<p>Считается, что потомков у угаритского не{{_}}было, хотя порядок букв близок к [[ps:Phnx|финикийскому]], "
    ...
    { "Wara", QFontDatabase::Any,
        ...
        u8"Письменность придумал с нуля лидер коммуны Лако Бодра, заявив, что она пришла ему в божественном откровении от некоего "
            ...
            "<p>Тип спорный: у каждой буквы есть гласная по умолчанию «а» (реже «о» или «э»), "
                    ...
                    "два регистра, все гласные буквы полные, не{{_}}огласовки. "
    ...
    { "Xpeo", QFontDatabase::Any,
        ...
        u8"Из [[ps:Xsux|шумеро-аккадской клинописи]] взят только принцип письма, символы почти полностью другие. "
            ...
            "<p>К 1800 расшифровали слово «царь». "
                "В 1802 Георг Гротефенд прочитал имена царей{{-}}он не{{_}}имел билингвы, только знал их греческое прочтение вроде "
    ...
    { "Yiii", QFontDatabase::Any,
        ...
        u8"И (носу)", Dating::year(1974, StdNote::CUSTOM), u8"слоговая",
        u8"и ''(Китай)''",
        u8"Первый известный экземпляр старого (иероглифического) письма '''и''' датируется ≈1500, но письмо наверняка намного старше. "
            ...
            "<p>Современный слоговой '''и''' придуман правительством Китая в 1974. В языке 43 согласных, 8 гласных и 4 тона "
                "(простой, p, t и x), но не{{_}}все комбинации возможны, и письмом '''и''' можно записать 1165 слогов.",
                EcFont::YI },
