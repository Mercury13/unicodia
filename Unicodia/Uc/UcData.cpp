    ...
    { "altcode", EcTermCat::INPUT,
      u8"Alt-коды", u8"Alt codes",
        u8"Появившийся ещё в DOS метод ввода символов по коду. "
                "В Windows линейки NT есть три типа кодов."
            "<p>'''Коды DOS'''"
            "<p>Удерживая '''Alt''' (в некоторых раскладках правый Alt работает как AltGr и не работает), "
                    "набрать на '''цифровой''' клавиатуре '''десятичный''' код символа. "
            ...
            "<p>'''Коды Windows'''"
            "<p>Удерживая '''Alt''', набрать на цифровой клавиатуре '''0''', затем '''десятичный''' код символа. "
                "Alt…0240 даст букву ð."
            "<p>Кодировка Windows-1252 независимо от настроек Windows. "
                "Коды 1…31 не работают. Коды 128…159{{-}}разные типографские символы. "
            ...
            "<p>Экспериментальные, работают не во всех программах. "
                "Чтобы они работали, надо в раздел реестра<br>"
                    ...
                    "добавить '''строковый''' параметр EnableHexNumpad=1."
