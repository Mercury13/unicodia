    ...
    { "birman", EcTermCat::INPUT,
      u8"типографская раскладка Ильи Бирмана", u8"Ilya Birman’s typography layout",
        u8"Существует в двух языках: английский (США) и русский, специальные клавиши для них одинаковы. "
             ...
             "<p>• европейские буквы и знаки ß ü ¿<br>"
                "• дореволюционная кириллица ѣ ѵ ѳ<br>"
                "• математика − ± ≠ ≈ ′ × ·<br>"
                "• некоторые индексы и дроби ½ ¹<br>"
                "• типографские знаки препинания « » “ ” —<br>"
                "• валюты € ₽ ¢<br>"
                "• стрелки ← → ↓ ↑<br>"
                "• несколько других символов ™ © ⌘"
            "<p>Раскладка 3.7, последняя на январь 2022, содержит [[pt:deprecated|запрещённые]] символы 〈〉. "
                "В следующих версиях это может измениться."
