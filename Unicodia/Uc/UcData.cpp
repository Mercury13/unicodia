...
constinit const uc::Block uc::blocks[302] {
    ...
    { 0x4DC0, 0x4DFF,
            ...
            u8"Книга перемен (И цзин){{-}}китайский эзотерический трактат, написанный разными поколениями людей. "
                    "Наиболее старая его часть написана около 700{{_}}до{{_}}н.э. и описывает знаменитую методику "
                ...
                "<p>Известно, что для гадания применялся пучок из 50 палочек, традиционно стеблей тысячелистника, но как именно{{-}}неизвестно. "
                    "Методы с бросанием монет появились позднее, а современное гадание на палочках{{-}}реконструкция."sv },
