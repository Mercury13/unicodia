...
constinit const uc::Block uc::blocks[] {
    ...
    { 0x1EE00, 0x1EEFF,
            ...
            u8"У арабов своя математическая нотация. "
                    "Они пользуются собственными буквами с написанием справа налево, и как на Западе есть прямой, жирный, курсив и другие, "
    ...
    { 0x1F000, 0x1F02F,
            ...
            u8"Азартная игра мацзян (часто через романизацию именуемая маджонг) изобретена в конце XIX{{_}}века, "
                ...
                "<p>Масти маджонга происходят от одной монеты (кольца), связки из 100 монет (бамбуки) и 10{{_}}тысяч монет "
