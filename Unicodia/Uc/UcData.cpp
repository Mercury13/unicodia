    ...
    { 0x2070, 0x209F,
            ...
            u8"<p>Блок содержит надстрочные и подстрочные буквы, знаки и цифры, применяемые в математике и фонетике. "
                "<p>Ещё до распространения интернета выяснилось: бездумное копирование текста может привести "
                        "к тому, что постоянная Планка «равняется» 6,632·1023. "
                    ...
                    "К тому же нарисованные типографом индексы обычно качественнее, чем синтезированные редактором документов."sv },
    // Curr symbols OK
    { 0x20A0, 0x20CF,
