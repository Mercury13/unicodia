...
constinit const uc::Block uc::blocks[N_BLOCKS] {
    ...
    { 0x11600, 0x1165F, "Modi"sv },
    { 0x11660, 0x1167F, "Mongolian Supplement"sv },
    { 0x11680, 0x116CF, "Takri"sv },
    { 0x11700, 0x1173F,
            "Ahom", u8"Ахом" },
    { 0x11800, 0x1184F, "Dogra"sv },
    { 0x118A0, 0x118FF, "Warang Citi"sv },
    { 0x11900, 0x1195F, "Dives Akuru"sv },
    { 0x119A0, 0x119FF, "Nandinagari"sv },
    { 0x11A00, 0x11A4F, "Zanabazar Square"sv },
    { 0x11A50, 0x11AAF, "Soyombo"sv },
    { 0x11AC0, 0x11AFF, "Pau Cin Hau"sv },
    { 0x11C00, 0x11C6F, "Bhaiksuki"sv },
    { 0x11C70, 0x11CBF, "Marchen"sv },
    { 0x11D00, 0x11D5F, "Masaram Gondi"sv },
    { 0x11D60, 0x11DAF, "Gunjala Gondi"sv },
    { 0x11EE0, 0x11EFF, "Makasar"sv },
    { 0x11FB0, 0x11FBF, "Lisu Supplement"sv },
    { 0x11FC0, 0x11FFF,
    ...
    { 0x12480, 0x1254F, "Early Dynastic Cuneiform"sv },
    { 0x13000, 0x1342F, "Egyptian Hieroglyphs"sv },
    { 0x13430, 0x1343F, "Egyptian Hieroglyph Format Controls"sv },
    { 0x14400, 0x1467F, "Anatolian Hieroglyphs"sv },
    { 0x16800, 0x16A3F, "Bamum Supplement"sv },
    { 0x16A40, 0x16A6F, "Mro"sv },
    { 0x16AD0, 0x16AFF, "Bassa Vah"sv },
    { 0x16B00, 0x16B8F, "Pahawh Hmong"sv },
    { 0x16E40, 0x16E9F, "Medefaidrin"sv },
    { 0x16F00, 0x16F9F,
            "Miao", u8"Мяо (письмо Полларда)" },
    { 0x16FE0, 0x16FFF, "Ideographic Symbols and Punctuation"sv },
    { 0x17000, 0x187FF, "Tangut"sv },
    { 0x18800, 0x18AFF, "Tangut Components"sv },
    { 0x18B00, 0x18CFF, "Khitan Small Script"sv },
    { 0x18D00, 0x18D8F, "Tangut Supplement"sv },
    { 0x1B000, 0x1B0FF,
