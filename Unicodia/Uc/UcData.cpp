...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Zanb", QFontDatabase::Any,
        ...
        u8"монгольский, лхаса ''(тибетский)'', санскрит",
        u8"Буддийский монах Дзанабадзар, языковед и художник, известен разработкой письма [[ps:Soyo|соёмбо]]. "
            ...
            "<p>Брахмийская абугида с гласной по умолчанию «а» и [[pt:virama|вирамой]]. "
                ...
                "Начальные гласные образуются прикреплением огласовок к {{sm|𑨩}}. "
