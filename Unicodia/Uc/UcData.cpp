    ...
    { "Tglg"sv, QFontDatabase::Any,
        ...
        u8"<p>Гласная по умолчанию «а».</p>"
            "<p>Испанские миссионеры (XVI{{_}}век) увидели, что островитяне поголовно грамотны, и сами стали учить их на байбайине. "
                "Даже не сразу поняли, в каком направлении пишут: текст вырезали на бамбуковых дощечках, направляя нож от себя, "
                "потому могли писать в одном направлении и читать в другом."
            "<p>Завезённые европейцами бумага, перо и печать сделали чёрное дело: в XVIII{{_}}веке обнаружили, "
                "что аборигены переняли [[pop_scr:Latn|латиницу]]. "
