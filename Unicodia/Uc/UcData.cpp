...
constinit const uc::Script uc::scriptInfo[] {
    ...
    { "Adlm", QFontDatabase::Any,
        ...
        u8"Фулá или фульбе{{-}}кочевники-скотоводы и самые ярые проповедники ислама в западной Африке."
    ...
    { "Ahom", QFontDatabase::Any,
        ...
        u8"Тайцы, переселившиеся в долину реки Брахмапутра, создали письменность на основе тогдашней индийской абугиды. "
                "К XIX веку язык окончательно заместился ассамским с [[ps:Beng|бенгальским]] письмом. Возрождается с 1954{{_}}года, "
