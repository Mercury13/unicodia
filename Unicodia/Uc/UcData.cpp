...
constinit const uc::Block uc::blocks[302] {
    ...
    { 0x1FB00, 0x1FBFF,
            ...
            u8"<p>Символы с разных компьютеров и систем 1970-х и 80-х:<br>"
                ...
                "<p>Часть символов с тех компьютеров в стандарт не вошла.<br>"
                    ...
                    "• Знаки прямой/инверсной заливки с Apple{{-}}у него [[pt:mono|знакоместо]] 7×8, и чтобы заливка не была клетчатой, "
                        "прямую заливку чередуют с инверсной.<br>"
                    "• [[pt:unification|Повторяющиеся]] знаки{{-}}причём в некоторых шрифтах оказывается, "
                        "что символы [[pt:pseudographics|псевдографики]] не стыкуются с символами из данного блока:<br>{{_}}{{_}}{{_}}{{sm|█🬗}}"sv,
            EcScript::NONE, EcFont::NOTO_SYMBOL2_BIGGER },
    /// @todo [tofu] CJK B
    /// @todo [desc] CJK B
    { 0x20000, 0x2A6DF,
    ...
    { "mono", EcTermCat::OTHER,
      u8"знакоместо"sv, u8"character cell"sv,
        u8"Воображаемая клетка, на которые разбивается моноширинный текст. "
                "<p>Текст на «знакоместа» делится и в [[pt:cjk|ККЯ]], но в первую очередь этот термин относится "
                    "к текстовым режимам компьютеров, алфавитно-цифровым принтерам."sv },
};
