...
constexpr const uc::BreakInfo1 breakInfoProto[] {
    ...
    { .id = "AK",  .strength = uc::BreakStrength::BRAH },
    { .id = "AP",  .strength = uc::BreakStrength::BRAH },
    { .id = "AS",  .strength = uc::BreakStrength::BRAH },
    { .id = "SA",  .strength = uc::BreakStrength::BRAH },
    { .id = "VF",  .strength = uc::BreakStrength::BRAH },
    { .id = "VI",  .strength = uc::BreakStrength::BRAH },
