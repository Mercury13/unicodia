...
* Block icons
  ...
  * 16×16 px, scale 1, no background, foreground for MISSING is pure white. Put them to ``Resources/Scripts``, optimize somehow, write a new filename to ``scripts.qrc``
