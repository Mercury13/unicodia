...
All tests (_/qa*_) CAN be run together, and produce files with respective names. Difference in files is a reason for investigation: in fonts, it can be something forgotten, and in HTTP — something really sinister.
