...
All tests (_/qa*_) immediately exit, CAN be run together, and produce files with respective names. Difference in files is a reason for investigation: in fonts, it can be something forgotten, and in HTTP — something really sinister.
...
* Greek-type scripts (Cari, Cher, Copt, Cyrl, Goth, Grek, Ital, Latn, Lyci, Lydi, Perm): the main approach is peculiar character
