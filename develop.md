...
* Block icons
  ...
  * 16×16 px, scale 1, no background, foreground is arbitrary. Put them to ``Resources/Scripts``, optimize somehow, write a new filename to ``scripts.qrc``
    * Do not deviate w/o reason from foreground of synthesized icons. MISSING → white FFF, international → black 000, Asia → Tango mid orange F57900, the rest continents → see SVGs.
