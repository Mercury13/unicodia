...
* Block icons
  ...
  * 16×16 px, scale 1, no background, foreground is arbitrary. Put them to ``Resources/Scripts``, optimize somehow, write a new filename to ``scripts.qrc``
    * **All new icons** will have foreground colour C01C28 (=Gnome red 4). This colour is automatically repainted to block-specific. Raise flag Ifg::PAINT_SVG to enable this feature. Of course, you may use any colour you want, but better use placeholder unless there’s a good reason.
