...
curl https://www.unicode.org/Public/15.1.0/ucd/Scripts.txt -L --output Scripts.txt
curl https://www.unicode.org/Public/15.1.0/ucd/PropertyValueAliases.txt -L --output PropertyValueAliases.txt
curl https://www.unicode.org/Public/15.1.0/ucd/UnicodeData.txt -L --output UnicodeData.txt
