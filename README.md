...
* When a new original has arrived: open the translation, press _File → Update data_. The interface will guide you. The command _Go → Find warnings → All_ can also help.
