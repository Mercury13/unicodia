...
**Russian.** Ё is mandatory. No grammatical concessions to Ukrainian. BLOCKS: if an adjective block is strongly connected to language, it’s male like language (грузинский). Otherwise female like script (батакская). SCRIPTS: always female — unlike English whose _script_ and _language_ are both neuter, and Ukrainian whose _писемність_ and _мова_ are female.
