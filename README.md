...
## Language
**Common.** No war jargon. Describe 2022 war as neutral as possible. Every _lingua franca_ (English, Russian) in its international form.
...
**Russian.** Ё is mandatory. No grammatical concessions to Ukrainian. BLOCKS: if an adjective block is strongly connected to language, it’s male like language (грузинский). Otherwise female like script (батакская). SCRIPTS: always female.
